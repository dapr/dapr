...
// body. timeout is the The timeout parameter is expressed in seconds. For more information, see <a
// href="https://docs.microsoft.com/en-us/rest/api/storageservices/setting-timeouts-for-queue-service-operations>Setting
// Timeouts for Queue Service Operations.</a> requestID is provides a client-generated, opaque value with a 1 KB
// character limit that is recorded in the analytics logs when storage analytics logging is enabled.
func (client serviceClient) ListQueuesSegment(ctx context.Context, prefix *string, marker *string, maxresults *int32, include ListQueuesIncludeType, timeout *int32, requestID *string) (*ListQueuesSegmentResponse, error) {
	...
	req, err := client.listQueuesSegmentPreparer(prefix, marker, maxresults, include, timeout, requestID)
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.listQueuesSegmentResponder}, req)
	if err != nil {
		return nil, err
	}
