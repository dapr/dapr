...
| `dapr_placement.volumeclaims.createStorageClass` | When set, creates a new Storage Class for the placement component using volumeclaims.storageClassName as the name of the new Storage Class and configure it with volumeclaims.storageClass | `false` |
...
| `dapr_placement.volumeclaims.storageClass.allowedTopologies` | List of TopologySelectorTerms to configure in a new storage class for the placement component if createStorageClass is set to true. | `[]` |
| `dapr_placement.volumeclaims.storageClass.allowVolumeExpansion` | Sets if the new storage class allows volume expansion for the placement component if createStorageClass is set to true. | `false` |
| `dapr_placement.volumeclaims.storageClass.annotations` | Dictionary (key: value pairs) of annotations to configure in a new storage class metadata for the placement component if createStorageClass is set to true.  | |
| `dapr_placement.volumeclaims.storageClass.labels` | Dictionary (key: value pairs) of labels to configure in a new storage class metadata for the placement component if createStorageClass is set to true.  | |
| `dapr_placement.volumeclaims.storageClass.mountOptions` | List of strings, sets the new storage class mountOptions for the placement component if createStorageClass is set to true. | `[]` |
| `dapr_placement.volumeclaims.storageClass.parameters` | Dictionary (key: value pairs) of parameters to configure in a new storage class for the placement component if createStorageClass is set to true. | `{}` |
| `dapr_placement.volumeclaims.storageClass.provisioner` | Name of the provisioner to configure in a new storage class for the placement component if createStorageClass is set to true. | |
| `dapr_placement.volumeclaims.storageClass.reclaimPolicy` | Sets the new storage class reclaimPolicy for the placement component if createStorageClass is set to true. | |
| `dapr_placement.volumeclaims.storageClass.volumeBindingMode` | Sets the new storage class volumeBindingMode for the placement component if createStorageClass is set to true. | |
...
| `dapr_scheduler.cluster.createStorageClass`   | When set, creates a new Storage Class for the scheduler using cluster.storageClassName as the name of the new Storage Class and configure it with cluster.storageClass                                                                                                                                                                               | `false`                                    |
...
| `dapr_scheduler.cluster.storageClass.allowedTopologies` | List of TopologySelectorTerms to configure in a new storage class for the scheduler if createStorageClass is set to true.                                                                                                                                                                                                                  | `[]`                                       |
| `dapr_scheduler.cluster.storageClass.allowVolumeExpansion` | Sets if the new storage class allows volume expansion for the scheduler if createStorageClass is set to true.                                                                                                                                                                                                                           | `false`                                    |
| `dapr_scheduler.cluster.storageClass.annotations` | Dictionary (key: value pairs) of annotations to configure in a new storage class metadata for the scheduler component if createStorageClass is set to true.                                                                                                                                                                                      |                                            |
| `dapr_scheduler.cluster.storageClass.labels` | Dictionary (key: value pairs) of labels to configure in a new storage class metadata for the scheduler component if createStorageClass is set to true.                                                                                                                                                                                                |                                            |
| `dapr_scheduler.cluster.storageClass.mountOptions` | List of strings, sets the new storage class mountOptions for the scheduler component if createStorageClass is set to true.                                                                                                                                                                                                                      | `[]`                                       |
| `dapr_scheduler.cluster.storageClass.parameters` | Dictionary (key: value pairs) of parameters to configure in a new storage class for the scheduler if createStorageClass is set to true.                                                                                                                                                                                                           | `{}`                                       |
| `dapr_scheduler.cluster.storageClass.provisioner` | Name of the provisioner to configure in a new storage class for the scheduler if createStorageClass is set to true.                                                                                                                                                                                                                              |                                            |
| `dapr_scheduler.cluster.storageClass.reclaimPolicy` | Sets the new storage class reclaimPolicy for the scheduler component if createStorageClass is set to true.                                                                                                                                                                                                                                     |                                            |
| `dapr_scheduler.cluster.storageClass.volumeBindingMode` | Sets the new storage class volumeBindingMode for the scheduler component if createStorageClass is set to true.                                                                                                                                                                                                                             |                                            |
