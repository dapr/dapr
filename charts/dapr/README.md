...
| `dapr_placement.podAntiAffinityPolicy` | Pod anti-affinity scheduling policy: `preferredDuringSchedulingIgnoredDuringExecution` (soft) or `requiredDuringSchedulingIgnoredDuringExecution` (hard). | `requiredDuringSchedulingIgnoredDuringExecution` |
...
| `dapr_scheduler.podAntiAffinityPolicy`        | Pod anti-affinity scheduling policy: `preferredDuringSchedulingIgnoredDuringExecution` (soft) or `requiredDuringSchedulingIgnoredDuringExecution` (hard).                                                                                                                                                                                             | `requiredDuringSchedulingIgnoredDuringExecution` |
