...
| `dapr_sidecar_injector.objectSelector`                    | Custom LabelSelector to only target specific pods                                                                                                                                                                                                                                                                                                                                                                                                                      | `~` |
| `dapr_sidecar_injector.namespaceSelector`                 | Custom LabelSelector to only target pods in specific namespaces                                                                                                                                                                                                                                                                                                                                                                                                        | `~` |
