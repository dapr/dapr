...
| `global.mtls.sentryAddress`                   | Sentry address for control plane                                                                                                                                                                        | `dapr-sentry.{{ .Release.Namespace }}.svc:443` |
| `global.mtls.mountSentryVolume`               | Gates whether the sentry bound service account token volume is mounted to control plane pods                                                                                                            | `true` |
