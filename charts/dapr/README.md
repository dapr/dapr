...
| `dapr_scheduler.cluster.etcdDataDirPath`      | Mount path for persistent volume for log store in unix-like system                                                                                           | `/var/lib/dapr/scheduler`                    |
| `dapr_scheduler.cluster.etcdDataDirWinPath`   | Mount path for persistent volume for log store in windows                                                                                                    | `C:\\dapr-scheduler`                         |
