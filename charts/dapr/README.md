...
| `dapr_sidecar_injector.dnsPolicy`                         | Set pod's dnsPolicy. This is helpful when `hostnetwork: true`. If set to `ClusterFirstWithHostNet` it will use in-cluster DNS instead of the host dns.                                                                                                                                                                                                                                                                                                                 | `ClusterFirst`                                                                                                                                                                                                            |
