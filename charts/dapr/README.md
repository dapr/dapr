...
| `dapr_scheduler.etcdMaxSnapshots`             | Maximum number of snapshot files to retain (0 is unlimited)                                                                                                                                                                                                                                                                                          | `5`                                          |
| `dapr_scheduler.etcdMaxWals`                  | Maximum number of write-ahead logs to retain (0 is unlimited)                                                                                                                                                                                                                                                                                        | `5`                                          |
