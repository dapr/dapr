...
| `dapr_operator.watchInterval`             | Interval for polling pods' state, in seconds (e.g. `120`). Set to `0` to disable, or `once` to only run once when the operator starts | `0` |
