...
| `dapr_placement.topologySpreadConstraints` | Topology spread constraints for placement pods. Only applies when HA is enabled. | `[]` |
| `dapr_placement.affinity` | Custom affinity rules for placement pods. Only applies when HA is enabled and replaces the default affinity. | `{}` |
...
| `dapr_scheduler.topologySpreadConstraints`    | Topology spread constraints for scheduler pods. Only applies when HA is enabled.                                                                                                                                                                                                                                                                      | `[]`                                       |
| `dapr_scheduler.affinity`                     | Custom affinity rules for scheduler pods that replace the default affinity.                                                                                                                                                                                                                                                                          | `{}`                                       |
