...
| Parameter                                   | Description                                                                                                                                       | Default                                      |
|---------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|
| `dapr_scheduler.replicaCount`               | Number of replicas (should be odd number or helm will fail)                                                                                       | `1`                                          |
| `dapr_scheduler.ha.replicaCount`            | Number of replicas when in HA mode (should be odd number or helm will fail)                                                                       | `3`                                          |
...
| `dapr_scheduler.runAsNonRoot`               | Boolean value for `securityContext.runAsNonRoot`. You may have to set this to `false` when running in Minikube                                    | `true`                                       |
