...
| `global.reminders.skipMigration`      | When enabled, skips the migration of legacy state store reminders to scheduler reminders. Useful to greatly improve placement actor dissemination time when no migration is required. | `false` |
