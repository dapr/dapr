...
| `global.topologySpreadConstraints`            | Topology spread constraints added to every control plane pod; a constraint without `labelSelector` is scoped to its own component's pods (`app: <component>`)                                           | `[]`                    |
