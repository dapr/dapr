...
This preview kit includes lots of improvements and new features such as Actor, Distributed tracing, Profiling, and enhanced side car injection, and offers new Actions .NET SDK.
