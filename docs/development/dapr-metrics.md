...
* dapr_component_job_successCount: The number of job triggers that returned success response
* dapr_component_job_failureCount: The number of job triggers that returned failure response
