...
Note: To run linter locally, please use golangci-lint version v1.55.2, otherwise you might encounter errors. You can download version v1.55.2 [here](https://github.com/golangci/golangci-lint/releases/tag/v1.55.2).
