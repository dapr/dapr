...
Note: To run linter locally, please use golangci-lint version v2.10.1, otherwise you might encounter errors. You can download version v2.10.1 [here](https://github.com/golangci/golangci-lint/releases/tag/v2.10.1).
