...
Note: To run linter locally, please use golangci-lint version v2.4.0, otherwise you might encounter errors. You can download version v2.4.0 [here](https://github.com/golangci/golangci-lint/releases/tag/v2.4.0).
