...
- **RESOLVED** Enforce timeout on component processing [2352](https://github.com/dapr/dapr/issues/2352)
...
- **RESOLVED** The pub/sub overview needs to describe how subscription and topic information is set [987](https://github.com/dapr/docs/issues/987)
...
- **RESOLVED** Document ignoreErrors component field. [1007](https://github.com/dapr/docs/issues/1007)

- **RESOLVED** Example step cert does not work https://docs.dapr.io/operations/security/mtls/ [1008](https://github.com/dapr/docs/issues/1008)
...
```sh
kubectl apply -f https://raw.githubusercontent.com/dapr/dapr/21636a9237f2dcecd9c80f329e99b512e8377739/charts/dapr/crds/configuration.yaml
kubectl apply -f https://raw.githubusercontent.com/dapr/dapr/21636a9237f2dcecd9c80f329e99b512e8377739/charts/dapr/crds/components.yaml
```
