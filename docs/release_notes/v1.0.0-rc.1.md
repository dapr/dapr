...
> Dapr CLI version 1.0.0-rc.1 is not compatible with previous runtime versions. Download the Dapr CLI 1.0.0-rc.1 from [here](https://github.com/dapr/cli/releases) and put the `dapr` binary in your PATH, or use the rc1 install script in the Getting Started guide.
