...
- **ADDED** Enable `runAsNonRoot` and `readOnlyRootFilesystem` for Dapr sidecar [5374](https://github.com/dapr/dapr/pull/5374)
- **ADDED** Allow Pods with `automountServiceAccountToken: false` - use bound tokens for identity in Dapr [5371](https://github.com/dapr/dapr/pull/5371) [5359](https://github.com/dapr/dapr/pull/5359) [5623](https://github.com/dapr/dapr/pull/5623)
...
- **RESOLVED** [PubSub] override cloud event attributes via metadata [5515](https://github.com/dapr/dapr/issues/5515) [5840](https://github.com/dapr/dapr/pull/5840)
- **RESOLVED** remove cloud event extensions duplicated data more effective [5521](https://github.com/dapr/dapr/pull/5521)
- **FIXED** Resiliency: setting `maxRetries: 0` is not parsed [5531](https://github.com/dapr/dapr/pull/5531)
- **UPDATED** Disallow including dots in app-id in self-hosted mode [5552](https://github.com/dapr/dapr/issues/5552)
...
- **ADDED** Allow component metadata value to use `{appID}` [5690](https://github.com/dapr/dapr/issues/5690)
...
- **RESOLVED** Allow Dapr to watch resources in a configured namespace with role bindings [5787](https://github.com/dapr/dapr/issues/5787) [5801](https://github.com/dapr/dapr/pull/5801)
- **UPDATED** Do not include "Server" header in HTTP responses [5821](https://github.com/dapr/dapr/pull/5821)
- **UPDATED** Use a separate service account for each Dapr control plane service [5767](https://github.com/dapr/dapr/pull/5767)
- **FIXED** Resiliency should not retry on 201-299 status codes [5863](https://github.com/dapr/dapr/pull/5863)
...
- **UPDATED** Changed "debug" Dockerfile to be based on Debian [5327](https://github.com/dapr/dapr/pull/5327)
- **UPDATED** Show deprecation notice for gRPC service invocation API [5324](https://github.com/dapr/dapr/pull/5324)
...
- **ADDED** Dapr Config CRD supports `.metrics` in addition to `.metric` [5824](https://github.com/dapr/dapr/pull/5824)
...
- **FIXED** Fixed multiple race conditions when Resiliency is enabled [5538](https://github.com/dapr/dapr/pull/5538)
...
- **UPDATED** Make Cron Binding input-only [2191](https://github.com/dapr/components-contrib/pull/2191)
...
- **UPDATED**: Use fully qualified names for container images [1090](https://github.com/dapr/cli/issues/1090)
...
- **ADDED** [Proposal] `dapr list --output json` includes related Dapr Compose configuration file metadata [1153](https://github.com/dapr/cli/issues/1153)
...
- **ADDED** [Proposal] `dapr run` track and `dapr list` display the PID of run commands [1191](https://github.com/dapr/cli/issues/1191)
...
- **UPDATED** Deprecate HTTP client in SDK [794](https://github.com/dapr/java-sdk/issues/794) [824](https://github.com/dapr/java-sdk/pull/824)
...
- **FIXED** Fix App-IDs across examples and tests [814](https://github.com/dapr/java-sdk/pull/814)
...
Java SDK is deprecating HTTP client, gRPC client will be the only implementation supported.
