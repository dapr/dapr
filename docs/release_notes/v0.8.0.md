...
* [Custom Pub/Sub routes](https://github.com/dapr/dapr/issues/1518)
* [Bi-directional bindings](https://github.com/dapr/dapr/issues/1116)
...
**Used** common components directory in user home directory.
