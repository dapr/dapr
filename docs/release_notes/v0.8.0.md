...
This release expands Dapr functionality with addition of bidirectional support for bindings and API authentication. With this release, we also made improvements to tracing.
...
**Fixed** End-to-end test for grpc_server_metrics
...
**Added** Support opentelemetry sementic convention (#1648)
 ...
 **Added** Linear interval wait for retry (#1628)
