...
Dapr 1.17.4 is built with Go 1.25.9, which includes security fixes to the go command, compiler, and the `archive/tar`, `crypto/tls`, `crypto/x509`, `html/template`, and `os` packages.
