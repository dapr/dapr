...
- [Scheduled jobs stop firing after a scheduler pod restart in a multi-node cluster](#scheduled-jobs-stop-firing-after-a-scheduler-pod-restart-in-a-multi-node-cluster)
