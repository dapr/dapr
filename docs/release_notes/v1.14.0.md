...
You can read more in the [Jobs API overview](https://v1-14.docs.dapr.io/developing-applications/building-blocks/jobs/jobs-overview/) documentation, or dive into a [Quickstart Go code example](https://v1-14.docs.dapr.io/getting-started/quickstarts/jobs-quickstart/). Support for Jobs is also in the Rust-SDK!
