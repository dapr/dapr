...
* Startign with this release, Dapr Helm chart repo has moved to [dapr.github.io/helm-charts](https://dapr.github.io/helm-charts/). In case of in-place cluster upgrade, the steps for adding the new repository to Helm are [outlined below](#2-upgrade-existing-cluster).
