...
If you're new to Dapr, visit the [getting started](https://docs.dapr.io/getting-started/) page and familiarize yourself with Dapr.
 ...
 - Support for Pub/Sub without CloudEvent wrapping, enabling communication between Dapr and non-Dapr applications [2308](https://github.com/dapr/dapr/issues/2308).
 - Allow choosing which APIs are available on Dapr sidecar [3054](https://github.com/dapr/dapr/issues/3054)
 - Many new components:
