...
The Azure Event Hubs pub/sub component advanced (checkpointed) its Event Hubs offset without regard to whether the application actually handled the event successfully.
...
You were affected if you consumed messages through the Azure Event Hubs pub/sub component.
...
The Event Hubs component now advances a partition's checkpoint only through contiguous, successfully-handled events or batches:
