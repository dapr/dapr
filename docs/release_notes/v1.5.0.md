...
### PostgreSQL State Store component (Alpha)

This release of the PostgreSQL State Store component (Alpha) cannot fetch data created with previous versions due to a schema change.
