...
- [Sentry fails to sign certificates when issuer key type does not match CSR signature algorithm](#sentry-fails-to-sign-certificates-when-issuer-key-type-does-not-match-csr-signature-algorithm)
