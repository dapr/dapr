...
- **FIXED** [actors] Actor reminders should return null if not
  registered [1468](https://github.com/dapr/dotnet-sdk/pull/1468)
...
- **FIXED** [conversation] Conversation SDK updated to reflect changes to
  protos [1469](https://github.com/dapr/dotnet-sdk/pull/1469)
...
- **FIXED** [jobs] Single-invocation point-in-time job fails to
  register [1455](https://github.com/dapr/dotnet-sdk/pull/1455)
...
- **FIXED** [jobs] Fix Jobs mapping handler to properly assign cancellation tokens per-request instead of
  globally [1474](https://github.com/dapr/dotnet-sdk/pull/1474)
