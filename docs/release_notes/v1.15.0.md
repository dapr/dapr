...
### Python SDK
The Python SDK added support for [streaming pub/sub](https://v1-15.docs.dapr.io/developing-applications/sdks/python/python-client/#streaming-message-subscription) APIs
