...
@1046102779, @AaronCrawfis, @abelperezok, @akkie, @alberthuang24, @amimimor, @amulyavarote, @artursouza, @beiwei30, @berndverst, @callmexiaolu88, @chinzhiweiblank, @chiru1221, @Cowlord711, @CrazyHZM,
...
- **FIXED** dapr reconnect logic with rabbitmq results in "channel not initialized" [4143](https://github.com/dapr/dapr/issues/4143)
...
- **ADDED** Publish Dapr images to GitHub container registry in addition to Docker Hub [4199](https://github.com/dapr/dapr/issues/4199)
...
## Deprecation Notices
- Content-type will not longer default to `application/json` if not explictly provided as a content-type header value for HTTP invocations starting in Dapr 1.9. Users are recommended to turn on the "service invocation without default `content-type`" [preview feature](https://v1-7.docs.dapr.io/operations/support/support-preview-features/) to evaluate the impact of this change.
