...
Now, upgrade Dapr to 1.0.0-rc.3 using the below commands:
...
##### 2. Upgrade from existing cluster running 1.0.0-rc.2
...
Then, upgrade Dapr to 1.0.0-rc.3 using the below commands:
...
helm install dapr dapr/dapr --version 1.0.0-rc.3 --namespace dapr-system
```
...
- **FIX** Empty etag treated as no etag. [2320](https://github.com/dapr/dapr/issues/2320)
