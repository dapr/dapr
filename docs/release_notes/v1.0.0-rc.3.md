...
* Added [dapr-distributed-calendar sample]9https://github.com/dapr/samples/tree/master/dapr-distributed-calendar)
...
- **FIX** Empty etags treated as empty etags. [2320](https://github.com/dapr/dapr/issues/2320)
...
The .NET SDK NuGet packages thatcorresponds with RC3 of the Dapr runtime use the version `1.0.0-rc04`.

The .NET SDK has several major feature additions and impactful changes in this release. We recommend every user read this [migration guide](https://github.com/dapr/dotnet-sdk/issues/569) as a supplement to the release notes.
...
- **Add** support for metada in pub/sbu [425](https://github.com/dapr/dotnet-sdk/issues/425)
...
- **ADD** DaprClient: Implement GetBulkSecretAsync [510](https://github.com/dapr/dotnet-sdk/issues/510)
...
- **ADD** More flexible options for HTTP service invocation [526](https://github.com/dapr/dotnet-sdk/issues/526)
...
You can upgrade Dapr using both Helm 3 and the Dapr CLI.
