...
- **UPDATED** Configuration API to use v1 endpoint [496](https://github.com/dapr/js-sdk/pull/496)
...
- **ADDED** Support for `saveBulkState` [433](https://github.com/dapr/js-sdk/issues/433)
