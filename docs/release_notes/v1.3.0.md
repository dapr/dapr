...
### Dapr Runtime
- **RESOLVED** Have Actor reminder to support ISO 8601 intervals standard format [2513](https://github.com/dapr/dapr/issues/2513)
- **RESOLVED** Persist actor reminders across multiple records [2889](https://github.com/dapr/dapr/issues/2889)
- **FIXED** Data race and concurrency problems of actor placement. [2961](https://github.com/dapr/dapr/issues/2961)
- **ADDED** Log missing app port when pub/sub component is loaded. [2979](https://github.com/dapr/dapr/issues/2979)
...
- **ADD:** Use pod anti-affinity for spreading across node for high-availability [3147](https://github.com/dapr/dapr/issues/3147)
...
- **ADDED** InvokeBinding API now returns metadata in HTTP [3326](https://github.com/dapr/dapr/issues/3326)
- **ADDED** Git commit hash to version output in STDOUT [3341](https://github.com/dapr/dapr/issues/3341)
...
- **ADDED** `--build-info` flag to output git commit hash of cli and runtime [599](https://github.com/dapr/cli/issues/599)
