...
* [Transaction support in the Azure CosmosDB component](https://github.com/dapr/docs/tree/master/howto/setup-state-store/setup-azure-cosmosdb.md)
* Dapr dashboard CLI command
* [Local development secretstore](https://github.com/dapr/docs/tree/master/howto/setup-secret-store/local-secret-store.md)
