...
* Added new components: [Scheduler binding](https://github.com/dapr/docs/blob/master/reference/specs/bindings/cron.md), [Postgresql state store](https://github.com/dapr/docs/tree/master/howto/setup-state-store/setup-postgresql.md)
...
* [Transaction support in Azure Cosmos DB component](https://github.com/dapr/docs/tree/master/howto/setup-state-store/setup-azure-cosmosdb.md)
* Dapr dashboard CLI command
* [Local secret store registration](https://github.com/dapr/docs/tree/master/howto/setup-secret-store/local-secret-store.md)
