...
replace (
	...
	// Just For Compile, it will remove after https://github.com/dapr/components-contrib/pull/543
	github.com/dapr/components-contrib => github.com/cvictory/components-contrib v1.0.0-rc1.0.20201126123216-708889873104
