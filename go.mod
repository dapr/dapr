...
// replace it before the code change in components-contrib is merged.
replace github.com/dapr/components-contrib => github.com/skyao/components-contrib v1.7.1-0.20220421155501-4013ed3f249b
