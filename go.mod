...
require (
	...
	github.com/wapc/wapc-go v0.5.5 // indirect
...
replace (
	...
	github.com/dapr/components-contrib => github.com/shubham1172/components-contrib v0.0.0-20221102124719-cfcb645c8edc
