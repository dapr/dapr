...
require (
	...
	github.com/dapr/durabletask-go v0.10.2-0.20251124230813-f3afee228ca1
...
replace github.com/dapr/durabletask-go => github.com/joshvanl/durabletask-go v0.0.0-20251202165130-db00c4379cdb
