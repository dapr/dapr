...
require (
	...
	github.com/dapr/components-contrib v1.8.0-rc.1.0.20220808165304-1148776d370d
...
replace github.com/dapr/components-contrib => github.com/1046102779/components-contrib v1.6.0-rc.2.0.20220819064350-862ec6edff91
