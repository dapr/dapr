...
require (
	...
	github.com/dapr/components-contrib v0.0.0-20191106001926-c945e702125e
...
replace github.com/dapr/components-contrib => github.com/flier/components-contrib v0.0.0-20191106034625-1b7679f19fed
