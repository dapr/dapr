...
require (
	...
	github.com/dapr/components-contrib v1.10.4-0.20230317211547-7e9b5a8b46d9
...
replace github.com/dapr/components-contrib => github.com/italypaleale/dapr-components-contrib v1.10.2-0.20230317230429-b60df4e1d10e
