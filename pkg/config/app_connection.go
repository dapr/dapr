...
const (
	...
	// DefaultBindingOptionsTimeout is the default timeout for the OPTIONS request
	// sent to an HTTP app to discover whether it is subscribed to an input binding.
