...
type MockAppChannel struct {
	mock.Mock
	requestsReceived map[string]*invokev1.InvokeMethodRequest
	mutex            sync.Mutex
}
...
func (_m *MockAppChannel) Init() {
	_m.mutex.Lock()
	_m.requestsReceived = make(map[string]*invokev1.InvokeMethodRequest)
	_m.mutex.Unlock()
}
...
func (_m *MockAppChannel) GetInvokedRequest() map[string]*invokev1.InvokeMethodRequest {
	_m.mutex.Lock()
