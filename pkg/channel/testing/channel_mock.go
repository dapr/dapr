...
type MockAppChannel struct {
	mock.Mock
	requestsReceived []*v1.InvokeMethodRequest
}
...
func (_m *MockAppChannel) Init() {
	_m.requestsReceived = make([]*v1.InvokeMethodRequest, 0)
}
...
func (_m *MockAppChannel) InvokeMethod(ctx context.Context, req *v1.InvokeMethodRequest) (*v1.InvokeMethodResponse, error) {
	_m.requestsReceived = append(_m.requestsReceived, req)
...
func (_m *MockAppChannel) GetInvokedRequest() []*v1.InvokeMethodRequest {
