...
const (
	...
	UnixDomainSocketDaprdPath      = "/run/dapr-sockets"                  // Path in the daprd container where UNIX domain sockets are mounted.
	...
	TokenVolumeKubernetesMountPath = "/run/secrets/dapr.io/sentrytoken"   /* #nosec */ // Mount path for the Kubernetes service account volume with the sentry token.
