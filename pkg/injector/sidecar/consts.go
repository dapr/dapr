...
const (
	...
	TokenVolumeKubernetesMountPath = "/var/run/secrets/kubernetes.io/serviceaccount" // Mount path for the Kubernetes service account volume.
	TokenVolumeName                = "dapr-identity-token"                           // Name of the volume with the service account token for daprd
)
