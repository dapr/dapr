...
// got https://raw.githubusercontent.com/etcd-io/etcd/refs/tags/v3.5.16/server/embed/etcd.go
...
func configurePeerListeners(cfg *Config) (peers []*peerListener, err error) {
	if cfg.PeerTLSInfo.Security != nil {
		cfg.logger.Info(
...
func (e *Etcd) servePeers() (err error) {
	...
	if e.cfg.PeerTLSInfo.Security != nil {
...
func configureClientListeners(cfg *Config) (sctxs map[string]*serveCtx, err error) {
	...
	for _, u := range append(cfg.ListenClientUrls, cfg.ListenClientHttpUrls...) {
		if u.Scheme == "http" || u.Scheme == "unix" {
			if cfg.ClientTLSInfo.Security != nil {
		...
		if (u.Scheme == "https" || u.Scheme == "unixs") && cfg.ClientTLSInfo.Security == nil {
