...
func TestStartWorkflowAlpha1API(t *testing.T) {
...
func TestGetWorkflowAlpha1API(t *testing.T) {
	fakeWorkflows := map[string]workflows.Workflow{
		fakeComponentName: &daprt.MockWorkflow{},
	}
...
func TestTerminateWorkflowAlpha1API(t *testing.T) {
	fakeWorkflows := map[string]workflows.Workflow{
		fakeComponentName: &daprt.MockWorkflow{},
	}
...
func TestRaiseEventWorkflowAlpha1Api(t *testing.T) {
...
func TestPauseWorkflowAlpha1Api(t *testing.T) {
	fakeWorkflows := map[string]workflows.Workflow{
		fakeComponentName: &daprt.MockWorkflow{},
	}
...
func TestResumeWorkflowAlpha1Api(t *testing.T) {
	fakeWorkflows := map[string]workflows.Workflow{
		fakeComponentName: &daprt.MockWorkflow{},
	}
