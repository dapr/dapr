...
func TestWorkflowAPI(t *testing.T) {
	t.Run("start workflow api", func(t *testing.T) {
	...
	t.Run("get workflow api", func(t *testing.T) {
		fakeWorkflows := map[string]workflows.Workflow{
			fakeComponentName: &daprt.MockWorkflow{},
		}
	...
	t.Run("terminate workflow api", func(t *testing.T) {
		fakeWorkflows := map[string]workflows.Workflow{
			fakeComponentName: &daprt.MockWorkflow{},
		}
	...
	t.Run("raise event workflow api", func(t *testing.T) {
	...
	t.Run("pause workflow api", func(t *testing.T) {
		fakeWorkflows := map[string]workflows.Workflow{
			fakeComponentName: &daprt.MockWorkflow{},
		}
	...
	t.Run("resume workflow api", func(t *testing.T) {
		fakeWorkflows := map[string]workflows.Workflow{
			fakeComponentName: &daprt.MockWorkflow{},
		}
