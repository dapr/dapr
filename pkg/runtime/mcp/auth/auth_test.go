...
func TestBuildHTTPClient_SPIFFEInjectsJWT(t *testing.T) {
	...
	client, err := BuildHTTPClient(context.Background(), context.Background(), srv, nil, fetcher)
	require.NoError(t, err)
...
func TestBuildHTTPClient_OAuth2InjectsBearer(t *testing.T) {
	...
	client, err := BuildHTTPClient(context.Background(), context.Background(), srv, cs, nil)
	require.NoError(t, err)
...
func TestBuildHTTPClient_OAuth2SecretFetchError(t *testing.T) {
	...
	_, err := BuildHTTPClient(context.Background(), context.Background(), srv, cs, nil)
	require.Error(t, err)
...
func TestBuildHTTPClient_StaticHeadersNoAuth(t *testing.T) {
	...
	client, err := BuildHTTPClient(context.Background(), context.Background(), &srv, nil, nil)
	require.NoError(t, err)
