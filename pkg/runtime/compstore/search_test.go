...
func (*fakeSearch) CreateIndex(context.Context, *contribsearch.CreateIndexRequest) error { return nil }

func (*fakeSearch) GetIndex(context.Context, *contribsearch.GetIndexRequest) (*contribsearch.GetIndexResponse, error) {
	return nil, nil
}
...
func (*fakeSearch) DeleteIndex(context.Context, *contribsearch.DeleteIndexRequest) error { return nil }
...
func (*fakeSearch) GetDocuments(context.Context, *contribsearch.GetDocumentsRequest) (*contribsearch.GetDocumentsResponse, error) {
	return nil, nil
}
