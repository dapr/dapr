...
func FromFlags() (*DaprRuntime, error) {
	...
	daprHTTPPortEnvName := flag.String("dapr-http-port-env-name", "", "HTTP port for Dapr get from Environment Variable")
	...
	daprAPIGRPCPortEnvName := flag.String("dapr-grpc-port-env-name", "", "gRPC port for the Dapr get from Environment Variable")
	daprInternalGRPCPort := flag.String("dapr-internal-grpc-port", "", "gRPC port for the Dapr Internal API to listen on")
	appPort := flag.String("app-port", "", "The port the application is listening on")
	appPortEnvName := flag.String("app-port-env-name", "", "The port the application get From Environment Variable"))
