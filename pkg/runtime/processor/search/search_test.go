...
func (*fakeSearchComponent) CreateIndex(context.Context, *contribsearch.CreateIndexRequest) error {
	return nil
}

func (*fakeSearchComponent) GetIndex(context.Context, *contribsearch.GetIndexRequest) (*contribsearch.GetIndexResponse, error) {
	return nil, nil
}
...
func (*fakeSearchComponent) DeleteIndex(context.Context, *contribsearch.DeleteIndexRequest) error {
	return nil
}
...
func (*fakeSearchComponent) GetDocuments(context.Context, *contribsearch.GetDocumentsRequest) (*contribsearch.GetDocumentsResponse, error) {
	return nil, nil
}
