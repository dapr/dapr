...
func NewRuntimeConfig(
	...
	enableProfiling bool, maxConcurrency int, mtlsEnabled bool, sentryAddress string, appSSL bool, maxRequestBodySize int, unixDomainSocket string, readBufferSize int, streamRequestBody bool, gracefulShutdownDuration time.Duration, apiLogLevel string,
) *Config {
	return &Config{
		ID:                  id,
		HTTPPort:            httpPort,
