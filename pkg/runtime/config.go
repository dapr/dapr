...
func NewRuntimeConfig(
	...
	unixDomainSocket string, readBufferSize int, streamRequestBody bool, gracefulShutdownDuration time.Duration, enableAPILogging bool, enableBuiltinSecretStore bool,
) *Config {
	return &Config{
		ID:                  id,
		HTTPPort:            httpPort,
		...
		EnableBuiltinSecretStore: enableBuiltinSecretStore,
	}
}
