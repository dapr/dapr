...
func (p *defaultBulkSubscriber) BulkSubscribe(ctx context.Context, req contribPubsub.SubscribeRequest, handler contribPubsub.BulkHandler) error {
	cfg := contribPubsub.BulkSubscribeConfig{
		MaxMessagesCount:   utils.GetIntValFromStringVal(req.BulkSubscribeRequest.MaxMessagesCount, defaultMaxMessagesCount),
		MaxAwaitDurationMs: utils.GetIntValFromStringVal(req.BulkSubscribeRequest.MaxAwaitDurationMs, defaultMaxAwaitDurationMs),
	}
