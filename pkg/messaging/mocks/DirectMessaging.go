...
// DirectMessaging is an autogenerated mock type for the DirectMessaging type
type DirectMessaging struct {
	mock.Mock
}

// Invoke provides a mock function with given fields: ctx, targetAppID, req
func (_m *DirectMessaging) Invoke(ctx context.Context, targetAppID string, req *v1.InvokeMethodRequest) (*v1.InvokeMethodResponse, error) {
