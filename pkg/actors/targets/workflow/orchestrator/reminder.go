...
func (o *orchestrator) createWorkflowReminder(ctx context.Context, reminderName string, data proto.Message, start time.Time, targetAppID string) error {
	actorType := o.actorTypeBuilder.Workflow(targetAppID)
	return o.createReminderWithType(ctx, reminderName, data, start, actorType)
}
...
func (o *orchestrator) assertNewEventReminder(ctx context.Context, e *backend.HistoryEvent, state *wfenginestate.State) error {
	...
	return o.createWorkflowReminder(ctx, reminderName, nil, dueTime, o.appID)
}
...
func (o *orchestrator) createReminderWithType(ctx context.Context, reminderName string, data proto.Message, start time.Time, actorType string) error {
	dueTime := start.UTC().Format(time.RFC3339)
