...
// validates the result and posts the completion event back to the
// workflow actor. Lives on factory because it must remain safe to invoke
// from a background goroutine after the owning *activity may have been
// recycled.
