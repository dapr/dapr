...
// NewMockActors initializes a new MockActors with a given max stack depth
func NewMockActors(maxStackDepth int32) *MockActors {
	return &MockActors{
...
func (_m *MockActors) Call(ctx context.Context, req *internalsv1pb.InternalInvokeRequest) (*internalsv1pb.InternalInvokeResponse, error) {
	...
	// If caller is the TestFIFOActorInvocation test, sleep for 500ns to simulate load
	// and force callers to wait for lock
	if strings.HasPrefix(req.GetMessage().GetMethod(), "TestFIFO") {
