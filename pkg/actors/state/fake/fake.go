...
type Fake struct {
	...
	transactionalStateOperationFn func(ctx context.Context, ignoreHosted, ignoreLock bool, req *api.TransactionalRequest) error
}
...
func (f *Fake) WithTransactionalStateOperationFn(fn func(ctx context.Context, ignoreHosted, ignoreLock bool, req *api.TransactionalRequest) error) *Fake {
...
func (f *Fake) TransactionalStateOperation(ctx context.Context, ignoreHosted, ignoreLock bool, req *api.TransactionalRequest) error {
	return f.transactionalStateOperationFn(ctx, ignoreHosted, ignoreLock, req)
}
