...
func TestReminderCountFiring(t *testing.T) {
	testReminders := newTestReminders()
	// testReminders.clock = clock.RealClock{}
	testReminders.clock = clocktesting.NewFakeClock(startOfTime)
	defer testReminders.Close()
	fakeStor = nil
...
// 	fakeStor = nil
// 	testReminders.SetStateStoreProvider(fakeRealTStoreWithNoLock)
...
// 	go func() {
// 		defer wg.Done()
// 		err := testReminders.CreateReminder(ctx, &CreateReminderRequest{
// 			ActorID:   actorID,
...
// 	// appChannel := new(mockAppChannel)
// 	testReminders := newTestReminders(appChannel)
// 	defer testReminders.Close()
...
// 	go func() {
// 		errs <- testReminders.CreateReminder(ctx, &CreateReminderRequest{
// 			ActorID:   actorID,
// 			ActorType: actorType,
// 			Name:      "reminder0",
// 			Period:    "1s",
...
// 	go func() {
// 		errs <- testReminders.RenameReminder(ctx, &RenameReminderRequest{
// 			ActorID:   actorID,
// 			ActorType: actorType,
// 			OldName:   "reminder0",
// 			NewName:   "reminder1",
...
// 	go func() {
// 		reminder, err := testReminders.GetReminder(ctx, &GetReminderRequest{
// 			ActorType: actorType,
// 			ActorID:   actorID,
// 			Name:      "reminder0",
// 		})
...
// 		require.NoError(t, testReminders.CreateReminder(ctx, &reminder2))
// 		require.NoError(t, testReminders.CreateReminder(ctx, &reminder3))
...
// 	appChannel := new(mockAppChannel)
// 	testReminders := newTestActorsRuntimeWithMockAndActorMetadataPartition(appChannel)
// 	defer testReminders.Close()
// 	stateStore, _ := testReminders.stateStore()
...
// 		err = testReminders.DeleteReminder(ctx, &DeleteReminderRequest{
// 			Name:      "reminder1",
// 			ActorID:   actorID,
// 			ActorType: actorType,
// 		})
...
// 		startCount := stateStore.(*daprt.FakeStateStore).CallCount("Multi")
// 		go func() {
// 			errs <- testReminders.DeleteReminder(ctx, &DeleteReminderRequest{
// 				Name:      "reminder1",
// 				ActorID:   actorID,
// 				ActorType: actorType,
// 			})
...
// 						require.NoError(t, testReminders.DeleteReminder(ctx, &DeleteReminderRequest{
// 							Name:      reminder.Name,
...
// 	assert.Equal(t, 1, len(testReminders.reminders[actorType]))
// 	r, err := testReminders.GetReminder(ctx, &GetReminderRequest{
// 		Name:      "reminder1",
// 		ActorID:   actorID,
// 		ActorType: actorType,
// 	})
...
// 	ctx := context.Background()
// 	actorKey := constructCompositeKey(actorType, actorID)
// 	require.NoError(t, testReminders.CreateReminder(ctx, &CreateReminderRequest{
// 		ActorID:   actorID,
// 		ActorType: actorType,
// 		Name:      "reminder1",
// 		Period:    "100ms",
