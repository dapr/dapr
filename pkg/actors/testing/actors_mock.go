...
func (_m *MockActors) RenameReminder(ctx context.Context, req *actors.RenameReminderRequest) error {
	ret := _m.Called(req)

	var r0 error
	if rf, ok := ret.Get(0).(func(request *actors.RenameReminderRequest) error); ok {
		r0 = rf(req)
	} else {
		r0 = ret.Error(0)
	}
