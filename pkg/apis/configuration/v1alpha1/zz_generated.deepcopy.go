...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActivityConcurrencyLimit) DeepCopyInto(out *ActivityConcurrencyLimit) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActivityConcurrencyLimit.
func (in *ActivityConcurrencyLimit) DeepCopy() *ActivityConcurrencyLimit {
	if in == nil {
		return nil
	}
	out := new(ActivityConcurrencyLimit)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetricHTTP) DeepCopyInto(out *MetricHTTP) {
	*out = *in
	...
	if in.PathMatching != nil {
		in, out := &in.PathMatching, &out.PathMatching
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *MetricSpec) DeepCopyInto(out *MetricSpec) {
	*out = *in
	...
	if in.LatencyDistributionBuckets != nil {
		in, out := &in.LatencyDistributionBuckets, &out.LatencyDistributionBuckets
		*out = new([]int)
		if **in != nil {
			in, out := *in, *out
			*out = make([]int, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamedConcurrencyLimit) DeepCopyInto(out *NamedConcurrencyLimit) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamedConcurrencyLimit.
func (in *NamedConcurrencyLimit) DeepCopy() *NamedConcurrencyLimit {
	if in == nil {
		return nil
	}
	out := new(NamedConcurrencyLimit)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkflowMetrics) DeepCopyInto(out *WorkflowMetrics) {
	*out = *in
	...
	if in.LatencyDistributionUnits != nil {
		in, out := &in.LatencyDistributionUnits, &out.LatencyDistributionUnits
		*out = new(v1.Duration)
		**out = **in
	}
}
...
func (in *WorkflowSpec) DeepCopyInto(out *WorkflowSpec) {
	*out = *in
	if in.GlobalMaxConcurrentWorkflowInvocations != nil {
		in, out := &in.GlobalMaxConcurrentWorkflowInvocations, &out.GlobalMaxConcurrentWorkflowInvocations
		*out = new(int32)
		**out = **in
	}
	if in.GlobalMaxConcurrentActivityInvocations != nil {
		in, out := &in.GlobalMaxConcurrentActivityInvocations, &out.GlobalMaxConcurrentActivityInvocations
		*out = new(int32)
		**out = **in
	}
	if in.WorkflowConcurrencyLimits != nil {
		in, out := &in.WorkflowConcurrencyLimits, &out.WorkflowConcurrencyLimits
		*out = make([]NamedConcurrencyLimit, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ActivityConcurrencyLimits != nil {
		in, out := &in.ActivityConcurrencyLimits, &out.ActivityConcurrencyLimits
		*out = make([]ActivityConcurrencyLimit, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.StateRetentionPolicy != nil {
		in, out := &in.StateRetentionPolicy, &out.StateRetentionPolicy
		*out = new(WorkflowStateRetentionPolicy)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkflowStateRetentionPolicy) DeepCopyInto(out *WorkflowStateRetentionPolicy) {
	*out = *in
	if in.AnyTerminal != nil {
		in, out := &in.AnyTerminal, &out.AnyTerminal
		*out = new(v1.Duration)
		**out = **in
	}
	if in.Completed != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkflowStateRetentionPolicy.
func (in *WorkflowStateRetentionPolicy) DeepCopy() *WorkflowStateRetentionPolicy {
	if in == nil {
		return nil
	}
	out := new(WorkflowStateRetentionPolicy)
