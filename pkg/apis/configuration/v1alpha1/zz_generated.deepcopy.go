...
func (in *GRPCPipelineSpec) DeepCopyInto(out *GRPCPipelineSpec) {
	*out = *in
	if in.UnaryInterceptors != nil {
		in, out := &in.UnaryInterceptors, &out.UnaryInterceptors
		*out = make([]UnarySpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnarySpec) DeepCopyInto(out *UnarySpec) {
	*out = *in
	in.SelectorSpec.DeepCopyInto(&out.SelectorSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnarySpec.
func (in *UnarySpec) DeepCopy() *UnarySpec {
	if in == nil {
		return nil
	}
	out := new(UnarySpec)
