...
func (in *MetricSpec) DeepCopyInto(out *MetricSpec) {
	*out = *in
	...
	if in.WorkflowLatencyDistributionBuckets != nil {
		in, out := &in.WorkflowLatencyDistributionBuckets, &out.WorkflowLatencyDistributionBuckets
		*out = new([]int)
		if **in != nil {
			in, out := *in, *out
			*out = make([]int, len(*in))
	...
	if in.WorkflowLatencyDistributionUnits != nil {
		in, out := &in.WorkflowLatencyDistributionUnits, &out.WorkflowLatencyDistributionUnits
		*out = new(v1.Duration)
		**out = **in
	}
}
