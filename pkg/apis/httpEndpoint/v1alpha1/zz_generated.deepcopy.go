...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericNameValueResource) DeepCopyInto(out *GenericNameValueResource) {
	*out = *in
	if in.Pairs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericNameValueResource.
func (in *GenericNameValueResource) DeepCopy() *GenericNameValueResource {
	if in == nil {
		return nil
	}
	out := new(GenericNameValueResource)
	in.DeepCopyInto(out)
	return out
}
