...
var eventsourcesResource = schema.GroupVersionResource{Group: "actions.io", Version: "v1alpha1", Resource: "eventsources"}

var eventsourcesKind = schema.GroupVersionKind{Group: "actions.io", Version: "v1alpha1", Kind: "EventSource"}
