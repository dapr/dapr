...
import (
	...
	mocks "github.com/dapr/dapr/pkg/diagnostics/utils"
...
func (m *MockGreeterClient) SayHello(ctx context.Context, in *mocks.HelloRequest, opts ...grpc.CallOption) (*mocks.HelloReply, error) {
	m.ctrl.T.Helper()
...
// SayHello mocks base method
func (m *MockGreeterServer) SayHello(arg0 context.Context, arg1 *mocks.HelloRequest) (*mocks.HelloReply, error) {
	m.ctrl.T.Helper()
