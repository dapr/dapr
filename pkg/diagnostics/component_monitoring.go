...
func (c *componentMetrics) PubsubIngressEvent(ctx context.Context, component, processStatus, topic string, elapsed float64) {
	if c.enabled {
		stats.RecordWithTags(
			ctx,
			diag_utils.WithTags(appIDKey, c.appID, namespaceKey, c.namespace, componentKey, component, processStatusKey, processStatus, topicKey, topic),
...
func (c *componentMetrics) PubsubEgressEvent(ctx context.Context, component, topic string, success bool, elapsed float64) {
	if c.enabled {
		stats.RecordWithTags(
			ctx,
			diag_utils.WithTags(appIDKey, c.appID, namespaceKey, c.namespace, componentKey, component, successKey, success, topicKey, topic),
...
func (c *componentMetrics) InputBindingEvent(ctx context.Context, component string, success bool, elapsed float64) {
	if c.enabled {
		stats.RecordWithTags(
			ctx,
			diag_utils.WithTags(appIDKey, c.appID, namespaceKey, c.namespace, componentKey, component, successKey, success),
...
func (c *componentMetrics) OutputBindingEvent(ctx context.Context, component, operation string, success bool, elapsed float64) {
	if c.enabled {
		stats.RecordWithTags(
			ctx,
			diag_utils.WithTags(appIDKey, c.appID, namespaceKey, c.namespace, componentKey, component, operationKey, operation, successKey, success),
...
func (c *componentMetrics) StateInvoked(ctx context.Context, component, operation string, success bool, elapsed float64) {
	if c.enabled {
		stats.RecordWithTags(
			ctx,
			diag_utils.WithTags(appIDKey, c.appID, namespaceKey, c.namespace, componentKey, component, successKey, success, operationKey, operation),
			c.stateCount.M(1))
