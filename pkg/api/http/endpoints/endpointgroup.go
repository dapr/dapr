...
const (
	...
	EndpointGroupSearch            EndpointGroupName = "search"
	EndpointGroupVector            EndpointGroupName = "vector"
)
...
const (
	...
	EndpointGroupVersion1alpha2 EndpointGroupVersion = "v1alpha2" // Alias: v1.0-alpha2
