...
const (
	...
	ErrPubsubRoutesInvalid      = "routing rules for topic %s in pubsub %s are not valid"
	ErrPubsubSubscribeFailed    = "error while subscribing to topic %s in pubsub %s: %v"
	ErrPubsubUnsubscribeFailed  = "error while unsubscribing from topic %s in pubsub %s: %v"
