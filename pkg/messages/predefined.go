...
var (
	...
	ErrOutboundHealthNotReadyService = APIError{"dapr outbound is not ready", errorcodes.HealthOutboundNotReady, http.StatusServiceUnavailable, grpcCodes.Unavailable}
