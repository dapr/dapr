...
var (
	...
	ErrActorMaxStackDepthExceeded    = APIError{"maximum stack depth exceeded", errorcodes.ErrActorMaxStackDepthExceeded, http.StatusTooManyRequests, grpcCodes.ResourceExhausted}
