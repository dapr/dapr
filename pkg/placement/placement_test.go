...
//func newTestPlacementServer(t *testing.T) (string, *Service, *clocktesting.FakeClock, context.CancelFunc) {
//	t.Helper()
//
...
//	serverAddress, testServer, clock, cleanup := newTestPlacementServer(t)
//	t.Cleanup(cleanup)
