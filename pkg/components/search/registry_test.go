...
func (*mockSearch) CreateIndex(context.Context, *contribsearch.CreateIndexRequest) error { return nil }

func (*mockSearch) GetIndex(context.Context, *contribsearch.GetIndexRequest) (*contribsearch.GetIndexResponse, error) {
	return nil, nil
}
...
func (*mockSearch) DeleteIndex(context.Context, *contribsearch.DeleteIndexRequest) error { return nil }
...
func (*mockSearch) GetDocuments(context.Context, *contribsearch.GetDocumentsRequest) (*contribsearch.GetDocumentsResponse, error) {
	return nil, nil
}
