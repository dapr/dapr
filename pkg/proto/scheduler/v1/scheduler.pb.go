...
// Instance0ReadyRequest is the message used by non dapr-scheduler-server-0
// instances to check if the etcd cluster is ready to join.
type Instance0ReadyRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// instance_name is the name of the Scheduler instance.
	InstanceName string `protobuf:"bytes,1,opt,name=instance_name,json=instanceName,proto3" json:"instance_name,omitempty"`
}

func (x *Instance0ReadyRequest) Reset() {
	*x = Instance0ReadyRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *Instance0ReadyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Instance0ReadyRequest) ProtoMessage() {}

func (x *Instance0ReadyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dapr_proto_scheduler_v1_scheduler_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Instance0ReadyRequest.ProtoReflect.Descriptor instead.
func (*Instance0ReadyRequest) Descriptor() ([]byte, []int) {
	return file_dapr_proto_scheduler_v1_scheduler_proto_rawDescGZIP(), []int{21}
}

func (x *Instance0ReadyRequest) GetInstanceName() string {
	if x != nil {
...
// Instance0ReadyResponse is the response message from the
// dapr-scheduler-server-0 instance to signal that the etcd cluster is ready to
// join.
type Instance0ReadyResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// initial_cluster is the optional string the client should use to join the
	// etcd cluster.
	InitialCluster *string `protobuf:"bytes,1,opt,name=initial_cluster,json=initialCluster,proto3,oneof" json:"initial_cluster,omitempty"`
}

func (x *Instance0ReadyResponse) Reset() {
	*x = Instance0ReadyResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *Instance0ReadyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Instance0ReadyResponse) ProtoMessage() {}

func (x *Instance0ReadyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dapr_proto_scheduler_v1_scheduler_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Instance0ReadyResponse.ProtoReflect.Descriptor instead.
func (*Instance0ReadyResponse) Descriptor() ([]byte, []int) {
	return file_dapr_proto_scheduler_v1_scheduler_proto_rawDescGZIP(), []int{22}
}

func (x *Instance0ReadyResponse) GetInitialCluster() string {
	if x != nil && x.InitialCluster != nil {
...
var file_dapr_proto_scheduler_v1_scheduler_proto_rawDesc = []byte{
	...
	,
	...
	0x5a, 0x0a, 0x16, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x30, 0x52, 0x65, 0x61, 0x64,
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x0f, 0x69, 0x6e, 0x69,
	0x74, 0x69, 0x61, 0x6c, 0x5f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x00, 0x52, 0x0e, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x43, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x88, 0x01, 0x01, 0x42, 0x12, 0x0a, 0x10, 0x5f, 0x69, 0x6e, 0x69, 0x74,
	0x69, 0x61, 0x6c, 0x5f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x2a, 0x4c, 0x0a, 0x0d, 0x4a,
	...
	0x10, 0x01, 0x32, 0xe7, 0x05, 0x0a, 0x09, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72,
	...
	,
...
var file_dapr_proto_scheduler_v1_scheduler_proto_goTypes = []interface{}{
	...
	(*Instance0ReadyRequest)(nil),     // 23: dapr.proto.scheduler.v1.Instance0ReadyRequest
	(*Instance0ReadyResponse)(nil),    // 24: dapr.proto.scheduler.v1.Instance0ReadyResponse
	(*anypb.Any)(nil),                 // 25: google.protobuf.Any
	(*FailurePolicy)(nil),             // 26: dapr.proto.scheduler.v1.FailurePolicy
}
var file_dapr_proto_scheduler_v1_scheduler_proto_depIdxs = []int32{
	...
	26, // 1: dapr.proto.scheduler.v1.Job.failure_policy:type_name -> dapr.proto.scheduler.v1.FailurePolicy
	...
	23, // 27: dapr.proto.scheduler.v1.Scheduler.Instance0Ready:input_type -> dapr.proto.scheduler.v1.Instance0ReadyRequest
	12, // 28: dapr.proto.scheduler.v1.Scheduler.ScheduleJob:output_type -> dapr.proto.scheduler.v1.ScheduleJobResponse
	14, // 29: dapr.proto.scheduler.v1.Scheduler.GetJob:output_type -> dapr.proto.scheduler.v1.GetJobResponse
	16, // 30: dapr.proto.scheduler.v1.Scheduler.DeleteJob:output_type -> dapr.proto.scheduler.v1.DeleteJobResponse
	10, // 31: dapr.proto.scheduler.v1.Scheduler.WatchJobs:output_type -> dapr.proto.scheduler.v1.WatchJobsResponse
	19, // 32: dapr.proto.scheduler.v1.Scheduler.ListJobs:output_type -> dapr.proto.scheduler.v1.ListJobsResponse
	21, // 33: dapr.proto.scheduler.v1.Scheduler.WatchHosts:output_type -> dapr.proto.scheduler.v1.WatchHostsResponse
	24, // 34: dapr.proto.scheduler.v1.Scheduler.Instance0Ready:output_type -> dapr.proto.scheduler.v1.Instance0ReadyResponse
...
func file_dapr_proto_scheduler_v1_scheduler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dapr_proto_scheduler_v1_scheduler_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Instance0ReadyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dapr_proto_scheduler_v1_scheduler_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Instance0ReadyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
