...
type TopicRoutes struct {
	...
	// Use data as payload when publishing message to app.
	DefaultDataAsPayload string `protobuf:"bytes,3,opt,name=default_data_as_payload,json=defaultDataAsPayload,proto3" json:"default_data_as_payload,omitempty"`
}
...
func (x *TopicRoutes) GetDefaultDataAsPayload() string {
	if x != nil {
		return x.DefaultDataAsPayload
	}
	return ""
}
...
type TopicRule struct {
	...
	// Use data as payload when publishing message to app.
	DataAsPayload string `protobuf:"bytes,3,opt,name=data_as_payload,json=dataAsPayload,proto3" json:"data_as_payload,omitempty"`
}
...
func (x *TopicRule) GetDataAsPayload() string {
	if x != nil {
		return x.DataAsPayload
	}
	return ""
}
...
var file_dapr_proto_runtime_v1_appcallback_proto_rawDesc = []byte{
	...
	0x01, 0x22, 0x96, 0x01, 0x0a, 0x0b, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x52, 0x6f, 0x75, 0x74, 0x65,
	...
	0x75, 0x6c, 0x74, 0x12, 0x35, 0x0a, 0x17, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x64,
	0x61, 0x74, 0x61, 0x5f, 0x61, 0x73, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x44, 0x61, 0x74,
	0x61, 0x41, 0x73, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x5d, 0x0a, 0x09, 0x54, 0x6f,
	...
	0x68, 0x12, 0x26, 0x0a, 0x0f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x61, 0x73, 0x5f, 0x70, 0x61, 0x79,
	0x6c, 0x6f, 0x61, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x64, 0x61, 0x74, 0x61,
	0x41, 0x73, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x37, 0x0a, 0x19, 0x4c, 0x69, 0x73,
