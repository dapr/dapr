...
var file_dapr_proto_runtime_v1_pubsub_proto_rawDesc = string([]byte{
...
var (
	...
	file_dapr_proto_runtime_v1_pubsub_proto_rawDescData []byte
)

func file_dapr_proto_runtime_v1_pubsub_proto_rawDescGZIP() []byte {
	file_dapr_proto_runtime_v1_pubsub_proto_rawDescOnce.Do(func() {
		file_dapr_proto_runtime_v1_pubsub_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dapr_proto_runtime_v1_pubsub_proto_rawDesc), len(file_dapr_proto_runtime_v1_pubsub_proto_rawDesc)))
	})
...
var file_dapr_proto_runtime_v1_pubsub_proto_goTypes = []any{
...
func file_dapr_proto_runtime_v1_pubsub_proto_init() {
	...
	file_dapr_proto_runtime_v1_pubsub_proto_msgTypes[5].OneofWrappers = []any{
		(*SubscribeTopicEventsRequestAlpha1_InitialRequest)(nil),
		(*SubscribeTopicEventsRequestAlpha1_EventProcessed)(nil),
	}
	file_dapr_proto_runtime_v1_pubsub_proto_msgTypes[6].OneofWrappers = []any{}
	file_dapr_proto_runtime_v1_pubsub_proto_msgTypes[8].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dapr_proto_runtime_v1_pubsub_proto_rawDesc), len(file_dapr_proto_runtime_v1_pubsub_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
