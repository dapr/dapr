...
var file_dapr_proto_runtime_v1_secret_proto_rawDesc = string([]byte{
...
var (
	...
	file_dapr_proto_runtime_v1_secret_proto_rawDescData []byte
)

func file_dapr_proto_runtime_v1_secret_proto_rawDescGZIP() []byte {
	file_dapr_proto_runtime_v1_secret_proto_rawDescOnce.Do(func() {
		file_dapr_proto_runtime_v1_secret_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dapr_proto_runtime_v1_secret_proto_rawDesc), len(file_dapr_proto_runtime_v1_secret_proto_rawDesc)))
	})
...
var file_dapr_proto_runtime_v1_secret_proto_goTypes = []any{
...
func file_dapr_proto_runtime_v1_secret_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dapr_proto_runtime_v1_secret_proto_rawDesc), len(file_dapr_proto_runtime_v1_secret_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
