...
type ExecuteStateTransactionRequest struct {
	...
	// Required. Array of TransactionalStateRequests
	Requests []*TransactionalStateRequest `protobuf:"bytes,2,rep,name=requests,proto3" json:"requests,omitempty"`
	// Options for concurrency and consistency to save the state.
	Options              *v1.StateOptions `protobuf:"bytes,3,opt,name=options,proto3" json:"options,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ExecuteStateTransactionRequest) GetOptions() *v1.StateOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
var fileDescriptor_da511bac0105b1e5 = []byte{
	...
	,
}
