...
type GetDistributeTransactionStateResponse struct {
	...
	TransactionID          string           `protobuf:"bytes,1,opt,name=TransactionID,proto3" json:"TransactionID,omitempty"`
	BunchTransactionStates map[string]int32 `protobuf:"bytes,2,rep,name=BunchTransactionStates,proto3" json:"BunchTransactionStates,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *GetDistributeTransactionStateResponse) GetBunchTransactionStates() map[string]int32 {
	if x != nil {
