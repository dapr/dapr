...
func (c *daprClient) DistributeTransactionBegin(ctx context.Context, in *BeginTransactionRequest, opts ...grpc.CallOption) (*BeginResponse, error) {
	out := new(BeginResponse)
	err := c.cc.Invoke(ctx, "/dapr.proto.runtime.v1.Dapr/DistributeTransactionBegin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetDistributeTransactionState(ctx context.Context, in *GetDistributeTransactionStateRequest, opts ...grpc.CallOption) (*GetDistributeTransactionStateResponse, error) {
	out := new(GetDistributeTransactionStateResponse)
	err := c.cc.Invoke(ctx, "/dapr.proto.runtime.v1.Dapr/GetDistributeTransactionState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDaprServer) DistributeTransactionBegin(context.Context, *BeginTransactionRequest) (*BeginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DistributeTransactionBegin not implemented")
}
...
func _Dapr_DistributeTransactionBegin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BeginTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).DistributeTransactionBegin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dapr.proto.runtime.v1.Dapr/DistributeTransactionBegin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaprServer).DistributeTransactionBegin(ctx, req.(*BeginTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dapr_GetDistributeTransactionState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDistributeTransactionStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).GetDistributeTransactionState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dapr.proto.runtime.v1.Dapr/GetDistributeTransactionState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaprServer).GetDistributeTransactionState(ctx, req.(*GetDistributeTransactionStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Dapr_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DistributeTransactionBegin",
			Handler:    _Dapr_DistributeTransactionBegin_Handler,
		},
		{
