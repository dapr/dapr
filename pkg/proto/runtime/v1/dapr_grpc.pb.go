...
const (
	...
	Dapr_SubscribeActorTopicEventsAlpha1_FullMethodName = "/dapr.proto.runtime.v1.Dapr/SubscribeActorTopicEventsAlpha1"
)
...
type DaprClient interface {
	...
	// SubscribeTopicActorEventsAlpha1 subscribes to a PubSub Actor topic and
	// receives topic events from it.
	SubscribeActorTopicEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (Dapr_SubscribeActorTopicEventsAlpha1Client, error)
}
...
func (c *daprClient) SubscribeActorTopicEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (Dapr_SubscribeActorTopicEventsAlpha1Client, error) {
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[5], Dapr_SubscribeActorTopicEventsAlpha1_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &daprSubscribeActorTopicEventsAlpha1Client{stream}
	return x, nil
}

type Dapr_SubscribeActorTopicEventsAlpha1Client interface {
	Send(*SubscribeActorEventRequestAlpha1) error
	Recv() (*SubscribeActorEventResponseAlpha1, error)
	grpc.ClientStream
}

type daprSubscribeActorTopicEventsAlpha1Client struct {
	grpc.ClientStream
}

func (x *daprSubscribeActorTopicEventsAlpha1Client) Send(m *SubscribeActorEventRequestAlpha1) error {
	return x.ClientStream.SendMsg(m)
}

func (x *daprSubscribeActorTopicEventsAlpha1Client) Recv() (*SubscribeActorEventResponseAlpha1, error) {
	m := new(SubscribeActorEventResponseAlpha1)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type DaprServer interface {
	...
	// SubscribeTopicActorEventsAlpha1 subscribes to a PubSub Actor topic and
	// receives topic events from it.
	SubscribeActorTopicEventsAlpha1(Dapr_SubscribeActorTopicEventsAlpha1Server) error
}
...
func (UnimplementedDaprServer) SubscribeActorTopicEventsAlpha1(Dapr_SubscribeActorTopicEventsAlpha1Server) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeActorTopicEventsAlpha1 not implemented")
}
...
func _Dapr_SubscribeActorTopicEventsAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaprServer).SubscribeActorTopicEventsAlpha1(&daprSubscribeActorTopicEventsAlpha1Server{stream})
}

type Dapr_SubscribeActorTopicEventsAlpha1Server interface {
	Send(*SubscribeActorEventResponseAlpha1) error
	Recv() (*SubscribeActorEventRequestAlpha1, error)
	grpc.ServerStream
}

type daprSubscribeActorTopicEventsAlpha1Server struct {
	grpc.ServerStream
}

func (x *daprSubscribeActorTopicEventsAlpha1Server) Send(m *SubscribeActorEventResponseAlpha1) error {
	return x.ServerStream.SendMsg(m)
}

func (x *daprSubscribeActorTopicEventsAlpha1Server) Recv() (*SubscribeActorEventRequestAlpha1, error) {
	m := new(SubscribeActorEventRequestAlpha1)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var Dapr_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SubscribeActorTopicEventsAlpha1",
			Handler:       _Dapr_SubscribeActorTopicEventsAlpha1_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
