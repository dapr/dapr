...
const (
	...
	Dapr_GetActorTimer_FullMethodName                  = "/dapr.proto.runtime.v1.Dapr/GetActorTimer"
	...
	Dapr_DeleteJobsByPrefix_FullMethodName             = "/dapr.proto.runtime.v1.Dapr/DeleteJobsByPrefix"
...
type DaprClient interface {
	...
	// events from it.
	SubscribeTopicEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1], error)
	...
	GetActorTimer(ctx context.Context, in *GetActorTimerRequest, opts ...grpc.CallOption) (*GetActorTimerResponse, error)
	...
	// actor callbacks.
	SubscribeActorEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1], error)
	...
	SubscribeConfigurationAlpha1(ctx context.Context, in *SubscribeConfigurationRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SubscribeConfigurationResponse], error)
	// SubscribeConfiguration gets configuration from configuration store and subscribe the updates event by grpc stream
	SubscribeConfiguration(ctx context.Context, in *SubscribeConfigurationRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SubscribeConfigurationResponse], error)
	...
	EncryptAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[EncryptRequest, EncryptResponse], error)
	// DecryptAlpha1 decrypts a message using the Dapr encryption scheme and a key stored in the vault.
	DecryptAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[DecryptRequest, DecryptResponse], error)
	...
	DeleteJobsByPrefix(ctx context.Context, in *DeleteJobsByPrefixRequest, opts ...grpc.CallOption) (*DeleteJobsByPrefixResponse, error)
	// Deprecated: Do not use.
	...
	SetBinaryFileAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SetBinaryFileRequest, SetBinaryFileResponse], error)
	// Retrieves a binary file as a stream of chunks.
	GetBinaryFileAlpha1(ctx context.Context, in *GetBinaryFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetBinaryFileResponse], error)
...
func (c *daprClient) InvokeService(ctx context.Context, in *InvokeServiceRequest, opts ...grpc.CallOption) (*v1.InvokeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_InvokeService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetState(ctx context.Context, in *GetStateRequest, opts ...grpc.CallOption) (*GetStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetBulkState(ctx context.Context, in *GetBulkStateRequest, opts ...grpc.CallOption) (*GetBulkStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetBulkState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SaveState(ctx context.Context, in *SaveStateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SaveState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) QueryStateAlpha1(ctx context.Context, in *QueryStateRequest, opts ...grpc.CallOption) (*QueryStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_QueryStateAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) DeleteState(ctx context.Context, in *DeleteStateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_DeleteState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) DeleteBulkState(ctx context.Context, in *DeleteBulkStateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_DeleteBulkState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ExecuteStateTransaction(ctx context.Context, in *ExecuteStateTransactionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_ExecuteStateTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) PublishEvent(ctx context.Context, in *PublishEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_PublishEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) BulkPublishEventAlpha1(ctx context.Context, in *BulkPublishRequest, opts ...grpc.CallOption) (*BulkPublishResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_BulkPublishEventAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) BulkPublishEvent(ctx context.Context, in *BulkPublishRequest, opts ...grpc.CallOption) (*BulkPublishResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BulkPublishResponse)
	err := c.cc.Invoke(ctx, Dapr_BulkPublishEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubscribeTopicEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[0], Dapr_SubscribeTopicEventsAlpha1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeTopicEventsAlpha1Client = grpc.BidiStreamingClient[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1]
...
func (c *daprClient) InvokeBinding(ctx context.Context, in *InvokeBindingRequest, opts ...grpc.CallOption) (*InvokeBindingResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_InvokeBinding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetSecret(ctx context.Context, in *GetSecretRequest, opts ...grpc.CallOption) (*GetSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetBulkSecret(ctx context.Context, in *GetBulkSecretRequest, opts ...grpc.CallOption) (*GetBulkSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetBulkSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) RegisterActorTimer(ctx context.Context, in *RegisterActorTimerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_RegisterActorTimer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) UnregisterActorTimer(ctx context.Context, in *UnregisterActorTimerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_UnregisterActorTimer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) RegisterActorReminder(ctx context.Context, in *RegisterActorReminderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_RegisterActorReminder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) UnregisterActorReminder(ctx context.Context, in *UnregisterActorReminderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_UnregisterActorReminder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) UnregisterActorRemindersByType(ctx context.Context, in *UnregisterActorRemindersByTypeRequest, opts ...grpc.CallOption) (*UnregisterActorRemindersByTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_UnregisterActorRemindersByType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ListActorReminders(ctx context.Context, in *ListActorRemindersRequest, opts ...grpc.CallOption) (*ListActorRemindersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_ListActorReminders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ListActorTimers(ctx context.Context, in *ListActorTimersRequest, opts ...grpc.CallOption) (*ListActorTimersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_ListActorTimers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetActorState(ctx context.Context, in *GetActorStateRequest, opts ...grpc.CallOption) (*GetActorStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetActorState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetActorReminder(ctx context.Context, in *GetActorReminderRequest, opts ...grpc.CallOption) (*GetActorReminderResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetActorReminder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetActorTimer(ctx context.Context, in *GetActorTimerRequest, opts ...grpc.CallOption) (*GetActorTimerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetActorTimerResponse)
	err := c.cc.Invoke(ctx, Dapr_GetActorTimer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ExecuteActorStateTransaction(ctx context.Context, in *ExecuteActorStateTransactionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_ExecuteActorStateTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) InvokeActor(ctx context.Context, in *InvokeActorRequest, opts ...grpc.CallOption) (*InvokeActorResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_InvokeActor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubscribeActorEventsAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[1], Dapr_SubscribeActorEventsAlpha1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeActorEventsAlpha1Client = grpc.BidiStreamingClient[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1]
...
func (c *daprClient) GetConfigurationAlpha1(ctx context.Context, in *GetConfigurationRequest, opts ...grpc.CallOption) (*GetConfigurationResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetConfigurationAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetConfiguration(ctx context.Context, in *GetConfigurationRequest, opts ...grpc.CallOption) (*GetConfigurationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetConfigurationResponse)
	err := c.cc.Invoke(ctx, Dapr_GetConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubscribeConfigurationAlpha1(ctx context.Context, in *SubscribeConfigurationRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SubscribeConfigurationResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[2], Dapr_SubscribeConfigurationAlpha1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeConfigurationRequest, SubscribeConfigurationResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeConfigurationAlpha1Client = grpc.ServerStreamingClient[SubscribeConfigurationResponse]

func (c *daprClient) SubscribeConfiguration(ctx context.Context, in *SubscribeConfigurationRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SubscribeConfigurationResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[3], Dapr_SubscribeConfiguration_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeConfigurationRequest, SubscribeConfigurationResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeConfigurationClient = grpc.ServerStreamingClient[SubscribeConfigurationResponse]
...
func (c *daprClient) UnsubscribeConfigurationAlpha1(ctx context.Context, in *UnsubscribeConfigurationRequest, opts ...grpc.CallOption) (*UnsubscribeConfigurationResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_UnsubscribeConfigurationAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) UnsubscribeConfiguration(ctx context.Context, in *UnsubscribeConfigurationRequest, opts ...grpc.CallOption) (*UnsubscribeConfigurationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UnsubscribeConfigurationResponse)
	err := c.cc.Invoke(ctx, Dapr_UnsubscribeConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) TryLockAlpha1(ctx context.Context, in *TryLockRequest, opts ...grpc.CallOption) (*TryLockResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_TryLockAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) UnlockAlpha1(ctx context.Context, in *UnlockRequest, opts ...grpc.CallOption) (*UnlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_UnlockAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) EncryptAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[EncryptRequest, EncryptResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[4], Dapr_EncryptAlpha1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_EncryptAlpha1Client = grpc.BidiStreamingClient[EncryptRequest, EncryptResponse]

func (c *daprClient) DecryptAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[DecryptRequest, DecryptResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[5], Dapr_DecryptAlpha1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_DecryptAlpha1Client = grpc.BidiStreamingClient[DecryptRequest, DecryptResponse]
...
func (c *daprClient) GetMetadata(ctx context.Context, in *GetMetadataRequest, opts ...grpc.CallOption) (*GetMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetMetadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SetMetadata(ctx context.Context, in *SetMetadataRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_SetMetadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubtleGetKeyAlpha1(ctx context.Context, in *SubtleGetKeyRequest, opts ...grpc.CallOption) (*SubtleGetKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SubtleGetKeyAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubtleEncryptAlpha1(ctx context.Context, in *SubtleEncryptRequest, opts ...grpc.CallOption) (*SubtleEncryptResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SubtleEncryptAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubtleDecryptAlpha1(ctx context.Context, in *SubtleDecryptRequest, opts ...grpc.CallOption) (*SubtleDecryptResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SubtleDecryptAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubtleWrapKeyAlpha1(ctx context.Context, in *SubtleWrapKeyRequest, opts ...grpc.CallOption) (*SubtleWrapKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SubtleWrapKeyAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubtleUnwrapKeyAlpha1(ctx context.Context, in *SubtleUnwrapKeyRequest, opts ...grpc.CallOption) (*SubtleUnwrapKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SubtleUnwrapKeyAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubtleSignAlpha1(ctx context.Context, in *SubtleSignRequest, opts ...grpc.CallOption) (*SubtleSignResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SubtleSignAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SubtleVerifyAlpha1(ctx context.Context, in *SubtleVerifyRequest, opts ...grpc.CallOption) (*SubtleVerifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_SubtleVerifyAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) StartWorkflowAlpha1(ctx context.Context, in *StartWorkflowRequest, opts ...grpc.CallOption) (*StartWorkflowResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_StartWorkflowAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetWorkflowAlpha1(ctx context.Context, in *GetWorkflowRequest, opts ...grpc.CallOption) (*GetWorkflowResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetWorkflowAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) PurgeWorkflowAlpha1(ctx context.Context, in *PurgeWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_PurgeWorkflowAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) TerminateWorkflowAlpha1(ctx context.Context, in *TerminateWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_TerminateWorkflowAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) PauseWorkflowAlpha1(ctx context.Context, in *PauseWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_PauseWorkflowAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ResumeWorkflowAlpha1(ctx context.Context, in *ResumeWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_ResumeWorkflowAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) RaiseEventWorkflowAlpha1(ctx context.Context, in *RaiseEventWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_RaiseEventWorkflowAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) StartWorkflowBeta1(ctx context.Context, in *StartWorkflowRequest, opts ...grpc.CallOption) (*StartWorkflowResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartWorkflowResponse)
	err := c.cc.Invoke(ctx, Dapr_StartWorkflowBeta1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetWorkflowBeta1(ctx context.Context, in *GetWorkflowRequest, opts ...grpc.CallOption) (*GetWorkflowResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetWorkflowResponse)
	err := c.cc.Invoke(ctx, Dapr_GetWorkflowBeta1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) PurgeWorkflowBeta1(ctx context.Context, in *PurgeWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_PurgeWorkflowBeta1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) TerminateWorkflowBeta1(ctx context.Context, in *TerminateWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_TerminateWorkflowBeta1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) PauseWorkflowBeta1(ctx context.Context, in *PauseWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_PauseWorkflowBeta1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ResumeWorkflowBeta1(ctx context.Context, in *ResumeWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_ResumeWorkflowBeta1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) RaiseEventWorkflowBeta1(ctx context.Context, in *RaiseEventWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_RaiseEventWorkflowBeta1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) Shutdown(ctx context.Context, in *ShutdownRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Dapr_Shutdown_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ScheduleJobAlpha1(ctx context.Context, in *ScheduleJobRequest, opts ...grpc.CallOption) (*ScheduleJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_ScheduleJobAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ScheduleJob(ctx context.Context, in *ScheduleJobRequest, opts ...grpc.CallOption) (*ScheduleJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ScheduleJobResponse)
	err := c.cc.Invoke(ctx, Dapr_ScheduleJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetJobAlpha1(ctx context.Context, in *GetJobRequest, opts ...grpc.CallOption) (*GetJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_GetJobAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) GetJob(ctx context.Context, in *GetJobRequest, opts ...grpc.CallOption) (*GetJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetJobResponse)
	err := c.cc.Invoke(ctx, Dapr_GetJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) DeleteJobAlpha1(ctx context.Context, in *DeleteJobRequest, opts ...grpc.CallOption) (*DeleteJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_DeleteJobAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) DeleteJob(ctx context.Context, in *DeleteJobRequest, opts ...grpc.CallOption) (*DeleteJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteJobResponse)
	err := c.cc.Invoke(ctx, Dapr_DeleteJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) DeleteJobsByPrefixAlpha1(ctx context.Context, in *DeleteJobsByPrefixRequestAlpha1, opts ...grpc.CallOption) (*DeleteJobsByPrefixResponseAlpha1, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_DeleteJobsByPrefixAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) DeleteJobsByPrefix(ctx context.Context, in *DeleteJobsByPrefixRequest, opts ...grpc.CallOption) (*DeleteJobsByPrefixResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteJobsByPrefixResponse)
	err := c.cc.Invoke(ctx, Dapr_DeleteJobsByPrefix_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ListJobsAlpha1(ctx context.Context, in *ListJobsRequestAlpha1, opts ...grpc.CallOption) (*ListJobsResponseAlpha1, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_ListJobsAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ListJobs(ctx context.Context, in *ListJobsRequest, opts ...grpc.CallOption) (*ListJobsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_ListJobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ConverseAlpha1(ctx context.Context, in *ConversationRequest, opts ...grpc.CallOption) (*ConversationResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_ConverseAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) ConverseAlpha2(ctx context.Context, in *ConversationRequestAlpha2, opts ...grpc.CallOption) (*ConversationResponseAlpha2, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConversationResponseAlpha2)
	err := c.cc.Invoke(ctx, Dapr_ConverseAlpha2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daprClient) SetBinaryFileAlpha1(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SetBinaryFileRequest, SetBinaryFileResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[6], Dapr_SetBinaryFileAlpha1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SetBinaryFileRequest, SetBinaryFileResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SetBinaryFileAlpha1Client = grpc.ClientStreamingClient[SetBinaryFileRequest, SetBinaryFileResponse]

func (c *daprClient) GetBinaryFileAlpha1(ctx context.Context, in *GetBinaryFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetBinaryFileResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Dapr_ServiceDesc.Streams[7], Dapr_GetBinaryFileAlpha1_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetBinaryFileRequest, GetBinaryFileResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_GetBinaryFileAlpha1Client = grpc.ServerStreamingClient[GetBinaryFileResponse]
...
func (c *daprClient) DeleteBinaryFileAlpha1(ctx context.Context, in *DeleteBinaryFileRequest, opts ...grpc.CallOption) (*DeleteBinaryFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, Dapr_DeleteBinaryFileAlpha1_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaprServer interface {
	...
	// SubscribeTopicEventsAlpha1 subscribes to a PubSub topic and receives topic
	// events from it.
	SubscribeTopicEventsAlpha1(grpc.BidiStreamingServer[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1]) error
	// Invokes binding data to specific output bindings
	...
	// Gets a timer registered on this host for an actor.
	GetActorTimer(context.Context, *GetActorTimerRequest) (*GetActorTimerResponse, error)
	// Executes state transactions for a specified actor
	...
	// it hosts. Apps using this RPC do not need to expose a server port for
	// actor callbacks.
	SubscribeActorEventsAlpha1(grpc.BidiStreamingServer[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1]) error
	// GetConfiguration gets configuration from configuration store.
	GetConfigurationAlpha1(context.Context, *GetConfigurationRequest) (*GetConfigurationResponse, error)
	// GetConfiguration gets configuration from configuration store.
	GetConfiguration(context.Context, *GetConfigurationRequest) (*GetConfigurationResponse, error)
	// SubscribeConfiguration gets configuration from configuration store and subscribe the updates event by grpc stream
	SubscribeConfigurationAlpha1(*SubscribeConfigurationRequest, grpc.ServerStreamingServer[SubscribeConfigurationResponse]) error
	// SubscribeConfiguration gets configuration from configuration store and subscribe the updates event by grpc stream
	SubscribeConfiguration(*SubscribeConfigurationRequest, grpc.ServerStreamingServer[SubscribeConfigurationResponse]) error
	// UnSubscribeConfiguration unsubscribe the subscription of configuration
	...
	// EncryptAlpha1 encrypts a message using the Dapr encryption scheme and a key stored in the vault.
	EncryptAlpha1(grpc.BidiStreamingServer[EncryptRequest, EncryptResponse]) error
	// DecryptAlpha1 decrypts a message using the Dapr encryption scheme and a key stored in the vault.
	DecryptAlpha1(grpc.BidiStreamingServer[DecryptRequest, DecryptResponse]) error
	// Gets metadata of the sidecar
	...
	// Delete jobs by name prefix
	DeleteJobsByPrefix(context.Context, *DeleteJobsByPrefixRequest) (*DeleteJobsByPrefixResponse, error)
	// Deprecated: Do not use.
	// Deprecated: List all jobs
	...
	// Stores a binary file using a streaming request. The first message must
	// contain the options; subsequent messages carry the file content as chunks.
	SetBinaryFileAlpha1(grpc.ClientStreamingServer[SetBinaryFileRequest, SetBinaryFileResponse]) error
	// Retrieves a binary file as a stream of chunks.
	GetBinaryFileAlpha1(*GetBinaryFileRequest, grpc.ServerStreamingServer[GetBinaryFileResponse]) error
	// Deletes a binary file.
	DeleteBinaryFileAlpha1(context.Context, *DeleteBinaryFileRequest) (*DeleteBinaryFileResponse, error)
}

// UnimplementedDaprServer should be embedded to have
...
func (UnimplementedDaprServer) SubscribeTopicEventsAlpha1(grpc.BidiStreamingServer[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1]) error {
...
func (UnimplementedDaprServer) GetActorTimer(context.Context, *GetActorTimerRequest) (*GetActorTimerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetActorTimer not implemented")
}
...
func (UnimplementedDaprServer) SubscribeActorEventsAlpha1(grpc.BidiStreamingServer[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1]) error {
...
func (UnimplementedDaprServer) SubscribeConfigurationAlpha1(*SubscribeConfigurationRequest, grpc.ServerStreamingServer[SubscribeConfigurationResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeConfigurationAlpha1 not implemented")
}
func (UnimplementedDaprServer) SubscribeConfiguration(*SubscribeConfigurationRequest, grpc.ServerStreamingServer[SubscribeConfigurationResponse]) error {
...
func (UnimplementedDaprServer) EncryptAlpha1(grpc.BidiStreamingServer[EncryptRequest, EncryptResponse]) error {
	return status.Errorf(codes.Unimplemented, "method EncryptAlpha1 not implemented")
}
func (UnimplementedDaprServer) DecryptAlpha1(grpc.BidiStreamingServer[DecryptRequest, DecryptResponse]) error {
...
func (UnimplementedDaprServer) ScheduleJob(context.Context, *ScheduleJobRequest) (*ScheduleJobResponse, error) {
...
func (UnimplementedDaprServer) GetJob(context.Context, *GetJobRequest) (*GetJobResponse, error) {
...
func (UnimplementedDaprServer) DeleteJob(context.Context, *DeleteJobRequest) (*DeleteJobResponse, error) {
...
func (UnimplementedDaprServer) DeleteJobsByPrefix(context.Context, *DeleteJobsByPrefixRequest) (*DeleteJobsByPrefixResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteJobsByPrefix not implemented")
}
...
func (UnimplementedDaprServer) SetBinaryFileAlpha1(grpc.ClientStreamingServer[SetBinaryFileRequest, SetBinaryFileResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SetBinaryFileAlpha1 not implemented")
}
func (UnimplementedDaprServer) GetBinaryFileAlpha1(*GetBinaryFileRequest, grpc.ServerStreamingServer[GetBinaryFileResponse]) error {
...
func (UnimplementedDaprServer) testEmbeddedByValue() {}
...
func RegisterDaprServer(s grpc.ServiceRegistrar, srv DaprServer) {
	// If the following call pancis, it indicates UnimplementedDaprServer was
...
func _Dapr_SubscribeTopicEventsAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaprServer).SubscribeTopicEventsAlpha1(&grpc.GenericServerStream[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeTopicEventsAlpha1Server = grpc.BidiStreamingServer[SubscribeTopicEventsRequestAlpha1, SubscribeTopicEventsResponseAlpha1]
...
func _Dapr_GetActorTimer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActorTimerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).GetActorTimer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Dapr_GetActorTimer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaprServer).GetActorTimer(ctx, req.(*GetActorTimerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Dapr_SubscribeActorEventsAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaprServer).SubscribeActorEventsAlpha1(&grpc.GenericServerStream[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeActorEventsAlpha1Server = grpc.BidiStreamingServer[SubscribeActorEventsRequestAlpha1, SubscribeActorEventsResponseAlpha1]
...
func _Dapr_SubscribeConfigurationAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DaprServer).SubscribeConfigurationAlpha1(m, &grpc.GenericServerStream[SubscribeConfigurationRequest, SubscribeConfigurationResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeConfigurationAlpha1Server = grpc.ServerStreamingServer[SubscribeConfigurationResponse]
...
func _Dapr_SubscribeConfiguration_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DaprServer).SubscribeConfiguration(m, &grpc.GenericServerStream[SubscribeConfigurationRequest, SubscribeConfigurationResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SubscribeConfigurationServer = grpc.ServerStreamingServer[SubscribeConfigurationResponse]
...
func _Dapr_EncryptAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaprServer).EncryptAlpha1(&grpc.GenericServerStream[EncryptRequest, EncryptResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_EncryptAlpha1Server = grpc.BidiStreamingServer[EncryptRequest, EncryptResponse]

func _Dapr_DecryptAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaprServer).DecryptAlpha1(&grpc.GenericServerStream[DecryptRequest, DecryptResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_DecryptAlpha1Server = grpc.BidiStreamingServer[DecryptRequest, DecryptResponse]
...
func _Dapr_ScheduleJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScheduleJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).ScheduleJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _Dapr_GetJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).GetJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _Dapr_DeleteJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).DeleteJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _Dapr_DeleteJobsByPrefix_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteJobsByPrefixRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).DeleteJobsByPrefix(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Dapr_DeleteJobsByPrefix_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaprServer).DeleteJobsByPrefix(ctx, req.(*DeleteJobsByPrefixRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Dapr_ListJobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListJobsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).ListJobs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _Dapr_ConverseAlpha2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConversationRequestAlpha2)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaprServer).ConverseAlpha2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Dapr_ConverseAlpha2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaprServer).ConverseAlpha2(ctx, req.(*ConversationRequestAlpha2))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dapr_SetBinaryFileAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaprServer).SetBinaryFileAlpha1(&grpc.GenericServerStream[SetBinaryFileRequest, SetBinaryFileResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_SetBinaryFileAlpha1Server = grpc.ClientStreamingServer[SetBinaryFileRequest, SetBinaryFileResponse]
...
func _Dapr_GetBinaryFileAlpha1_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DaprServer).GetBinaryFileAlpha1(m, &grpc.GenericServerStream[GetBinaryFileRequest, GetBinaryFileResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Dapr_GetBinaryFileAlpha1Server = grpc.ServerStreamingServer[GetBinaryFileResponse]
...
var Dapr_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetActorTimer",
			Handler:    _Dapr_GetActorTimer_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Dapr_ScheduleJob_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Dapr_DeleteJob_Handler,
		},
		{
		...
		{
			MethodName: "DeleteJobsByPrefix",
			Handler:    _Dapr_DeleteJobsByPrefix_Handler,
		},
		{
