...
func (c *appCallbackClient) OnBulkTopicEvent(ctx context.Context, in *TopicEventBulkRequest, opts ...grpc.CallOption) (*TopicEventBulkResponse, error) {
	...
	err := c.cc.Invoke(ctx, AppCallback_OnBulkTopicEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appCallbackClient) OnJobEvent(ctx context.Context, in *JobEventRequest, opts ...grpc.CallOption) (*JobEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, AppCallback_OnJobEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAppCallbackServer should be embedded to have
...
// UnimplementedAppCallbackHealthCheckServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
// UnimplementedAppCallbackAlphaServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
