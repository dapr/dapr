...
func (m *MockDirectMessaging) Invoke(ctx context.Context, targetAppID string, req *v1.InvokeMethodRequest) (*v1.InvokeMethodResponse, error) {
	ret := m.Called(ctx, targetAppID, req)
...
func (m *MockDirectMessaging) Close() error {
	return nil
}
