...
func New(origArgs []string) (*Options, error) {
	...
	fs.StringVar(&opts.DisableInitEndpoints, "disable-init-endpoints", "", "List of initialization endpoints to disable. Supported values: config, subscribe,. If not specified, all endpoints will be enabled")
