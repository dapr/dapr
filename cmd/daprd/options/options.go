...
func New(origArgs []string) (*Options, error) {
	...
	fs.StringVar(&opts.RegisterWorkflowBackend, "register-workflow-backend", "true", "Enable or disables the registration of the Workflow backend")
	fs.StringVar(&opts.RegisterActivityBackend, "register-activity-backend", "true", "Enable or disables the registration of the Workflow Activity backend")
