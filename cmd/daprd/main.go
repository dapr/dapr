...
import (
	...
	alicloud_parameterstore "github.com/dapr/components-contrib/secretstores/alicloud/parameterstore"
	...
	err = rt.Run(
		runtime.WithSecretStores(
			...
			secretstores_loader.New("alicloud.parameterstore", func() secretstores.SecretStore {
				return alicloud_parameterstore.NewParameterStore(logContrib)
			}),
		),
		runtime.WithStates(
