...
This will deploy our Node app to Kubernetes. **NOTE**: While the actions runtime images are private, you will only be able to deploy images by creating a secret. You can do this by executing:
