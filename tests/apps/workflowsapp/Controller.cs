...
namespace DaprDemoActor
{
  ...
  public class Controller : ControllerBase
  {
    ...
    private static readonly DaprClient daprClient = new DaprClientBuilder().UseGrpcEndpoint(grpcEndpoint).UseHttpEndpoint(httpEndpoint).Build();
    ...
    public async Task<ActionResult<string>> StartWorkflow([FromRoute] string instanceID, string workflowName, string workflowComponent)
    {
      ...
      return startResponse.InstanceId;
    }
