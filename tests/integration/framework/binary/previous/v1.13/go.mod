module github.com/dapr/dapr/tests/integration/framework/binary/v1.13

go 1.22.3

require github.com/dapr/dapr v1.13.0-rc.8
...
require (
	...
	github.com/dapr/components-contrib v1.13.0-rc.7 // indirect
