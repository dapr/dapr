...
func init() {
	suite.Register(new(deletebynameprefix))
}

type deletebynameprefix struct {
	scheduler *scheduler.Scheduler
}

func (d *deletebynameprefix) Setup(t *testing.T) []framework.Option {
...
func (d *deletebynameprefix) Run(t *testing.T, ctx context.Context) {
	...
	t.Run("jobs", func(t *testing.T) {
		...
		_, err = client.DeleteByNamePrefix(ctx, &schedulerv1.DeleteByNamePrefixRequest{
			NamePrefix: "",
			Metadata: &schedulerv1.JobMetadata{
				AppId:     "appid",
				Namespace: "namespace",
