...
func (r *remove) Run(t *testing.T, ctx context.Context) {
	...
	}, 30*time.Second, 10*time.Millisecond, "failed to wait for 'triggered' to be greater or equal 1, actual value "+strconv.FormatInt(r.triggered.Load(), 10)) //nolint:mnd
