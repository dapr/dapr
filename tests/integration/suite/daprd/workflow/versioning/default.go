...
func init() {
	suite.Register(new(defaultToLatest))
}

type defaultToLatest struct {
	workflow *workflow.Workflow
}

func (d *defaultToLatest) Setup(t *testing.T) []framework.Option {
...
func (d *defaultToLatest) Run(t *testing.T, ctx context.Context) {
