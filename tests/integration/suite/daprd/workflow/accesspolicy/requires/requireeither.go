  ...
  - callers:
    ...
    - name: %s
      ...
      - eventType: activity.completed
        name: vip-verified
        appID: %s
`, r.targetID, r.callerID, r.sensitiveChildWF, r.callerID, r.sensitiveChildWF, r.callerID)
...
func (r *requireeither) Run(t *testing.T, ctx context.Context) {
	...
	require.NoError(t, caller.AddWorkflowN(r.wfPathA, func(ctx *task.WorkflowContext) (any, error) {
	...
	require.NoError(t, caller.AddWorkflowN(r.wfPathB, func(ctx *task.WorkflowContext) (any, error) {
