...
func (r *resume) newWorkflow(ctx *task.OrchestrationContext) (any, error) {
...
func (r *resume) sayHello1(ctx task.ActivityContext) (any, error) {
	return "Hello", nil
}

func (r *resume) sayHello2(ctx task.ActivityContext) (any, error) {
	return "Hello", nil
}
