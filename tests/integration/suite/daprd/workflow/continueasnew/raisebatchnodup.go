...
func (r *raisebatchnodup) Run(t *testing.T, ctx context.Context) {
	...
	require.NoError(t, r.workflow.Registry().AddOrchestratorN("raisebatchnodup", func(ctx *task.OrchestrationContext) (any, error) {
		var inc int
	...
	id, err := client.ScheduleNewOrchestration(ctx, "raisebatchnodup",
