...
func (e *edges) Run(t *testing.T, ctx context.Context) {
	...
	t.Run("partial consumption preserves unconsumed events", func(t *testing.T) {
		...
		require.NoError(t, reg.AddOrchestratorN("edge-partial", func(ctx *task.OrchestrationContext) (any, error) {
			var st state
		...
		id, err := client.ScheduleNewOrchestration(ctx, "edge-partial",
	...
	t.Run("FIFO ordering preserved across CAN boundaries", func(t *testing.T) {
		...
		require.NoError(t, reg.AddOrchestratorN("edge-fifo", func(ctx *task.OrchestrationContext) (any, error) {
			var st state
			require.NoError(t, ctx.GetInput(&st))
		...
		id, err := client.ScheduleNewOrchestration(ctx, "edge-fifo",
	...
	t.Run("immediate CAN tight-loop without events", func(t *testing.T) {
		require.NoError(t, reg.AddOrchestratorN("edge-tightloop", func(ctx *task.OrchestrationContext) (any, error) {
			var counter int
		...
		id, err := client.ScheduleNewOrchestration(ctx, "edge-tightloop",
	...
	t.Run("CAN after activity failure", func(t *testing.T) {
		...
		require.NoError(t, reg.AddOrchestratorN("edge-act-fail", func(ctx *task.OrchestrationContext) (any, error) {
			var attempt int
		...
		id, err := client.ScheduleNewOrchestration(ctx, "edge-act-fail",
	...
	t.Run("custom status resets after CAN", func(t *testing.T) {
		...
		require.NoError(t, reg.AddOrchestratorN("edge-status", func(ctx *task.OrchestrationContext) (any, error) {
		...
		id, err := client.ScheduleNewOrchestration(ctx, "edge-status",
	...
	t.Run("keep events with timer in same iteration", func(t *testing.T) {
		...
		require.NoError(t, reg.AddOrchestratorN("edge-timer-keep", func(ctx *task.OrchestrationContext) (any, error) {
			var st state
			require.NoError(t, ctx.GetInput(&st))
		...
		id, err := client.ScheduleNewOrchestration(ctx, "edge-timer-keep",
