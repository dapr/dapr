...
func (o *two) Setup(t *testing.T) []framework.Option {
...
func (o *two) Run(t *testing.T, ctx context.Context) {
	...
	newID, err := client.RerunWorkflowFromEvent(ctx, api.InstanceID("abc"), 1)
	require.NoError(t, err)
