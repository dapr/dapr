...
func (a *active) Run(t *testing.T, ctx context.Context) {
	...
	a.workflow.Registry().AddWorkflowN("active-event", func(ctx *task.WorkflowContext) (any, error) {
	...
	id, err := client.ScheduleNewWorkflow(ctx, "active-event", api.WithInstanceID("xyz"))
