...
func (sr *skipresolved) Run(t *testing.T, ctx context.Context) {
	...
	sr.workflow.Registry().AddOrchestratorN("dedup-skipresolved", func(ctx *task.OrchestrationContext) (any, error) {
	...
	id, err := cl.ScheduleNewOrchestration(ctx, "dedup-skipresolved")
