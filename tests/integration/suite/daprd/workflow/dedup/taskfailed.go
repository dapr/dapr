...
func (tf *taskfailed) Run(t *testing.T, ctx context.Context) {
	...
	tf.workflow.Registry().AddOrchestratorN("dedup-taskfailed", func(ctx *task.OrchestrationContext) (any, error) {
	...
	id, err := cl.ScheduleNewOrchestration(ctx, "dedup-taskfailed")
