...
func (c *continueasnew) Run(t *testing.T, ctx context.Context) {
	...
	c.workflow.Registry().AddOrchestratorN("dedup-continueasnew", func(ctx *task.OrchestrationContext) (any, error) {
		var iter int
	...
	id, err := cl.ScheduleNewOrchestration(ctx, "dedup-continueasnew")
