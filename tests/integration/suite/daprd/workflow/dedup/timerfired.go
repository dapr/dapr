...
func (tf *timerfired) Run(t *testing.T, ctx context.Context) {
	...
	tf.workflow.Registry().AddOrchestratorN("dedup-timerfired", func(ctx *task.OrchestrationContext) (any, error) {
	...
	id, err := cl.ScheduleNewOrchestration(ctx, "dedup-timerfired")
