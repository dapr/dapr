...
func (tc *taskcompleted) Run(t *testing.T, ctx context.Context) {
	...
	tc.workflow.Registry().AddOrchestratorN("dedup-taskcompleted", func(ctx *task.OrchestrationContext) (any, error) {
	...
	id, err := cl.ScheduleNewOrchestration(ctx, "dedup-taskcompleted")
