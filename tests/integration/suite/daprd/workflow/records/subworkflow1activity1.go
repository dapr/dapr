...
func init() {
	suite.Register(new(subworkflow1activity1))
}

type subworkflow1activity1 struct {
	workflow *workflow.Workflow
}

func (a *subworkflow1activity1) Setup(t *testing.T) []framework.Option {
...
func (a *subworkflow1activity1) Run(t *testing.T, ctx context.Context) {
