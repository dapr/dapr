...
func (f *failedchild) Setup(t *testing.T) []framework.Option {
...
func (f *failedchild) Run(t *testing.T, ctx context.Context) {
	...
	reg.AddWorkflowN("attest-fail-child", func(ctx *dworkflow.WorkflowContext) (any, error) {
