...
func (w *workflowPayloadSizeStalled) Run(t *testing.T, ctx context.Context) {
	...
	require.NoError(t, reg.AddOrchestratorN("stalled_payload_wf", func(wctx *task.OrchestrationContext) (any, error) {
	...
	id, err := client.ScheduleNewOrchestration(ctx, "stalled_payload_wf")
