...
func (p *pki) Setup(t *testing.T) []framework.Option {
	...
	certs := testsutil.GenPKI(t, testsutil.PKIOptions{LeafDNS: "localhost"})
...
func (p *pki) Run(t *testing.T, ctx context.Context) {
	...
	// if windows, the error message is different https://github.com/golang/go/blob/release-branch.go1.22/src/crypto/x509/platform_test.go#L172-L173
