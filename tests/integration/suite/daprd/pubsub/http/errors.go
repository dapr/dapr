...
func (e *errorcodes) Run(t *testing.T, ctx context.Context) {
	...
	t.Run("pubsub doesn't exist", func(t *testing.T) {
		...
		require.True(t, e.daprd.FoundMetric(t, ctx, 1, "dapr_error_code_total", "category:pubsub", "error_code:ERR_PUBSUB_NOT_FOUND"))
	...
	t.Run("pubsub unmarshal events", func(t *testing.T) {
		...
		require.True(t, e.daprd.FoundMetric(t, ctx, 1, "dapr_error_code_total", "category:pubsub", "error_code:ERR_PUBSUB_EVENTS_SER"))
	...
	t.Run("pubsub metadata deserialization", func(t *testing.T) {
		...
		require.True(t, e.daprd.FoundMetric(t, ctx, 1, "dapr_error_code_total", "category:pubsub", "error_code:ERR_PUBSUB_REQUEST_METADATA"))
	...
	t.Run("pubsub cloud event creation issue", func(t *testing.T) {
		...
		require.True(t, e.daprd.FoundMetric(t, ctx, 1, "dapr_error_code_total", "category:pubsub", "error_code:ERR_PUBSUB_CLOUD_EVENTS_SER"))
	...
	t.Run("pubsub outbox", func(t *testing.T) {
		...
		require.True(t, e.daprd.FoundMetric(t, ctx, 1, "dapr_error_code_total", "category:pubsub", "error_code:ERR_PUBLISH_OUTBOX"))
