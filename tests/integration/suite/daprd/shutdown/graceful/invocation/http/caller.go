...
func (c *caller) Setup(t *testing.T) []framework.Option {
	os.SkipWindows(t)
...
func (c *caller) Run(t *testing.T, ctx context.Context) {
	...
	url := fmt.Sprintf("http://%s/v1.0/invoke/%s/method/foo", c.daprd2.HTTPAddress(), c.daprd1.AppID())
