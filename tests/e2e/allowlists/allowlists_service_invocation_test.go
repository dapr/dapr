...
var allowListsForServiceInvocationTests = []struct {
...
}{
	{
		...
		"opAllow",
		kube.FormatAppID("allowlists-callee-http"),
		"opAllow",
		"opAllow is called",
		"http",
		200,
	},
	{
		...
		kube.FormatAppID("allowlists-callee-http"),
		"opDeny",
		fmt.Sprintf("failed to invoke, id: %s, err: rpc error: code = PermissionDenied desc = access control policy has denied access to id: spiffe://public/ns/%s/%s operation: opDeny verb: POST", kube.FormatAppID("allowlists-callee-http"), kube.DaprTestNamespace, kube.FormatAppID("allowlists-caller")),
		"http",
		403,
	},
	{
		...
		"grpctogrpctest",
		kube.FormatAppID("allowlists-callee-grpc"),
		"grpcToGrpcTest",
		"success",
		"grpc",
		200,
	...
	},
	{
		...
		kube.FormatAppID("allowlists-callee-grpc"),
		"httptogrpctest",
		fmt.Sprintf("HTTP call failed with failed to invoke, id: %s, err: rpc error: code = PermissionDenied desc = access control policy has denied access to id: spiffe://public/ns/%s/%s operation: httpToGrpcTest verb: NONE", kube.DaprTestNamespace, kube.FormatAppID("allowlists-caller")),
		"grpc",
		403,
	},
}
