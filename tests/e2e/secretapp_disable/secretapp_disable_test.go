...
const (
	...
	appName         = "secretapp_disable" // App name in Dapr.
	numHealthChecks = 60                  // Number of get calls before starting tests.
	secretKey       = "daprsecretcheck"
	validValue      = "value1"
)
	...
	return []testCase{
		{
			...
			newRequest(secretStore, utils.SimpleKeyValue{allowedSecret, validValue}),
			newResponse(secretStore, utils.SimpleKeyValue{allowedSecret, validValue}),
			true,
			401,
