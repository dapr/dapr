...
func TestDeployApp(t *testing.T) {
	...
	assert.Equal(t, testApp.AppName, deployment.Name)
	...
	assert.Equal(t, "true", deployment.Spec.Template.Annotations["dapr.io/enabled"])
...
func TestCreateIngressService(t *testing.T) {
	...
	t.Run("Ingress is disabled", func(t *testing.T) {
		...
		assert.NotNil(t, obj)
		assert.Equal(t, testApp.AppName, obj.Name)
		assert.Equal(t, testNamespace, obj.Namespace)
