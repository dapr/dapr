...
setup-test-components: setup-app-configurations
	...
	$(KUBECTL) apply -f ./tests/config/dapr_redis_configuration.yaml --namespace $(DAPR_TEST_NAMESPACE)
	$(KUBECTL) apply -f ./tests/config/dapr_postgres_configuration.yaml --namespace $(DAPR_TEST_NAMESPACE)
