...
test-e2e-all: check-e2e-env
	...
	# test
	kubectl get pods -n $(DAPR_TEST_NAMESPACE)
	kubectl describe pod dapr-placement -n $(DAPR_TEST_NAMESPACE)
	kubectl describe pod dapr-operator -n $(DAPR_TEST_NAMESPACE)
	kubectl describe pod dapr-sidecar-injector -n $(DAPR_TEST_NAMESPACE)
