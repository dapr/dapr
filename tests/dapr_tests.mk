...
setup-test-env-k6: controller-gen
	...
	export IMG_NAME=ghcr.io/grafana/k6-operator:controller && export IMG_TAG=v0.0.14 && rm -rf /tmp/.k6-operator >/dev/null && git clone --depth 1 --branch v0.0.14 https://github.com/grafana/k6-operator /tmp/.k6-operator && cd /tmp/.k6-operator && make deploy && cd - && rm -rf /tmp/.k6-operator
