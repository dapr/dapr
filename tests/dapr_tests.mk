...
setup-test-components: setup-app-configurations
	...
	$(KUBECTL) apply -f ./tests/config/kubernetes_wfacl_config.yaml --namespace $(DAPR_TEST_NAMESPACE) || true
	$(KUBECTL) apply -f ./tests/config/kubernetes_wfacl_policy.yaml --namespace $(DAPR_TEST_NAMESPACE) || true
