...
setup-test-components: setup-app-configurations
	...
	$(KUBECTL) apply -f ./tests/config/config_map_pipeline.yaml --namespace $(DAPR_TEST_NAMESPACE)
	$(KUBECTL) apply -f ./tests/config/config_map_components.yaml --namespace $(DAPR_TEST_NAMESPACE)
